...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Lemma} \coqdef{Ch06 3.Exercise6 12.monus Sn m}{monus\_Sn\_m}{\coqdoclemma{monus\_Sn\_m}} : \coqdockw{\ensuremath{\forall}} \coqdocvar{n} \coqdocvar{m}, \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{(}}\coqdocdefinition{le} \coqdocvariable{m} \coqdocvariable{n}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{)}} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqref{Ch06 3.Exercise6 12.monus}{\coqdocdefinition{monus}} (\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvariable{n}) \coqdocvariable{m} \coqdocnotation{=} \coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} (\coqref{Ch06 3.Exercise6 12.monus}{\coqdocdefinition{monus}} \coqdocvariable{n} \coqdocvariable{m}).\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{2.00em}
\coqdocvar{transparent} \coqdoctac{assert} (\coqdocvar{H'} : (\coqdocdefinition{le} \coqdocvar{m} \coqdocvar{n})).\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{apply} (\coqdoclemma{le\_trans} \coqdocvar{m} (\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvar{m}) \coqdocvar{n}). \coqdoctac{apply} \coqref{Ch06 3.Exercise6 12.n le Sn}{\coqdoclemma{n\_le\_Sn}}. \coqdoctac{apply} \coqdocvar{H}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{refine} (\coqdocnotation{(}\coqdocdefinition{ap} \coqdocdefinition{pred} (\coqdocvar{IHm} \coqdocvar{H'})\coqdocnotation{)} \coqdocnotation{@} \coqdocvar{\_}). \coqdoctac{clear} \coqdocvar{H'}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{simpl}. \coqdoctac{symmetry}. \coqdoctac{apply} \coqdoclemma{S\_pred\_inv}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{intro} \coqdocvar{H'}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{apply} \coqref{Ch06 3.Exercise6 12.monus eq O  n le m}{\coqdocaxiom{monus\_eq\_O\_\_n\_le\_m}} \coqdoctac{in} \coqdocvar{H'}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{apply} \coqdoclemma{le\_antisymmetric} \coqdoctac{in} \coqdocvar{H'}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{destruct} \coqdocvar{H} \coqdockw{as} [\coqdocvar{k} \coqdocvar{p}]. \coqdoctac{simpl} \coqdoctac{in} \coqdocvar{p}.\coqdoceol
\coqdocindent{2.00em}
\coqdocvar{transparent} \coqdoctac{assert} (\coqdocvar{H'{}'} : (\coqdocvar{m} \coqdocnotation{=} \coqdocdefinition{plus} \coqdocvar{m} (\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvar{k}))).\coqdoceol
\coqdocindent{3.00em}
\coqdoctac{apply} (\coqdocvar{H'} \coqdocnotation{@} \coqdocvar{p}\coqdocnotation{\^{}} \coqdocnotation{@} \coqdocnotation{(}\coqdoclemma{plus\_n\_Sm} \coqdocvar{\_} \coqdocvar{\_}\coqdocnotation{)}).\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{apply} \coqdoclemma{Ch03.baz} \coqdoctac{in} \coqdocvar{H'{}'}. \coqdocvar{contradiction}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{apply} (\coqdoclemma{le\_trans} \coqdocvar{m} (\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvar{m}) \coqdocvar{n}). \coqdoctac{apply} \coqref{Ch06 3.Exercise6 12.n le Sn}{\coqdoclemma{n\_le\_Sn}}. \coqdoctac{apply} \coqdocvar{H}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
...
\coqdocindent{1.00em}
\coqdoctac{destruct} (\coqdoclemma{order\_partitions} \coqdocvar{b} \coqdocvar{a}).\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{1.00em}
\coqdoctac{\ensuremath{\exists}} \coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvar{n}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}. \coqdoctac{reflexivity}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{\ensuremath{\exists}} \coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}. \coqdoctac{reflexivity}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{\ensuremath{\exists}} \coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvar{n}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}. \coqdoctac{reflexivity}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocindent{1.00em}
\coqdoctac{apply} (\coqdocnotation{(}\coqdoclemma{plus\_n\_Sm} \coqdocvar{\_} \coqdocvar{\_}\coqdocnotation{)\^{}} \coqdocnotation{@} \coqdocvar{p}).\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocindent{1.00em}
\coqdoctac{unfold} \coqref{Ch06 3.Exercise6 12.r}{\coqdocdefinition{r}} \coqdoctac{in} \coqdocvar{p}. \coqdoctac{simpl}. \coqdoctac{destruct} (\coqdoclemma{order\_partitions} \coqdocvar{b} \coqdocvar{a}); \coqdoctac{refine} (\coqdocvar{\_} \coqdocnotation{@} \coqdocvar{p});\coqdoceol
\coqdocindent{2.00em}
...
\coqdocindent{2.00em}
\coqdoctac{assert} (\coqdocabbreviation{IsHSet} (\coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{\ensuremath{\times}}} \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}})) \coqdockw{as} \coqdocvar{Hn}. \coqdoctac{apply} \coqref{Ch06 3.Exercise6 12.hset prod}{\coqdoclemma{hset\_prod}}; \coqdoctac{apply} \coqdoclemma{ishset\_nat}.\coqdoceol
\coqdocindent{2.00em}
