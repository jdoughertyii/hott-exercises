...
\coqdocindent{4.50em}
\coqdef{Ch06 3.m set}{m\_set}{\coqdocprojection{m\_set}} :> \coqdocrecord{hSet} ;\coqdoceol
\coqdocindent{4.50em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdef{Ch06 3.hprop inverse exists}{hprop\_inverse\_exists}{\coqdoclemma{hprop\_inverse\_exists}} (\coqdocvar{G} : \coqdocrecord{hSet}) (\coqdocvar{m} : \coqdocvariable{G} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{G} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{G}) (\coqdocvar{e} : \coqdocvariable{G}) \coqdoceol
\coqdocindent{4.00em}
(\coqdocvar{HG} : \coqref{Ch06 3.IsMonoid}{\coqdocclass{IsMonoid}} \coqdocvariable{G} \coqdocvariable{m} \coqdocvariable{e})\coqdoceol
\coqdocnoindent
: \coqdockw{\ensuremath{\forall}} \coqdocvar{x}, \coqdocabbreviation{IsHProp} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\{}}\coqdocvar{y} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{:}} \coqdocvariable{G} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\&}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocvariable{m} \coqdocvariable{x} \coqdocvar{y} \coqdocnotation{=} \coqdocvariable{e}\coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{\ensuremath{\times}}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocvariable{m} \coqdocvar{y} \coqdocvariable{x} \coqdocnotation{=} \coqdocvariable{e}\coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\}}}.\coqdoceol
\coqdocnoindent
...
\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{assert} (\coqdockw{\ensuremath{\forall}} \coqdocvar{y} : \coqdocvar{G}, \coqdocabbreviation{IsHProp} (\coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocvar{m} \coqdocvar{x} \coqdocvariable{y} \coqdocnotation{=} \coqdocvar{e}\coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{\ensuremath{\times}}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocvar{m} \coqdocvariable{y} \coqdocvar{x} \coqdocnotation{=} \coqdocvar{e}\coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}})). \coqdoctac{intro} \coqdocvar{y}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{destruct} \coqdocvar{HG}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{refine} (\coqdocnotation{(}\coqdocvar{m\_unitr0} \coqdocvar{\_}\coqdocnotation{)\^{}} \coqdocnotation{@} \coqdocvar{\_}).\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{refine} (\coqdocvar{\_} \coqdocnotation{@} \coqdocnotation{(}\coqdocvar{m\_unitl0} \coqdocvar{\_}\coqdocnotation{)}).\coqdoceol
\coqdocindent{1.00em}
\coqdocvar{path\_via} (\coqdocvar{m} \coqdocvar{u}\coqdocnotation{.1} (\coqdocvar{m} \coqdocvar{x} \coqdocvar{v}\coqdocnotation{.1})). \coqdocvar{f\_ap}. \coqdoctac{symmetry}. \coqdoctac{apply} (\coqexternalref{fst}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocprojection{fst}} \coqdocvar{v}\coqdocnotation{.2}).\coqdoceol
\coqdocindent{1.00em}
\coqdocvar{path\_via} (\coqdocvar{m} (\coqdocvar{m} \coqdocvar{u}\coqdocnotation{.1} \coqdocvar{x}) \coqdocvar{v}\coqdocnotation{.1}). \coqdocvar{f\_ap}. \coqdoctac{apply} (\coqexternalref{snd}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocprojection{snd}} \coqdocvar{u}\coqdocnotation{.2}).\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdef{Ch06 3.ex6 7}{ex6\_7}{\coqdoclemma{ex6\_7}} `\{\coqdocclass{Funext}\} :\coqdoceol
\coqdocindent{1.00em}
\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\{}}\coqdocvar{G} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{:}} \coqref{Ch06 3.Monoid}{\coqdocrecord{Monoid}} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\&}} \coqdockw{\ensuremath{\forall}} \coqdocvar{x}, \coqdocabbreviation{Brck} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\{}}\coqdocvar{y} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{:}} \coqdocvar{G} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\&}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocvar{G} \coqdocvariable{x} \coqdocvar{y} \coqdocnotation{=} \coqdocvar{G}\coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{\ensuremath{\times}}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocvar{G} \coqdocvar{y} \coqdocvariable{x} \coqdocnotation{=} \coqdocvar{G}\coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\}\}}}\coqdoceol
\coqdocindent{1.00em}
\coqdocnotation{\ensuremath{\eqvsym}}\coqdoceol
\coqdocindent{1.00em}
\coqref{Ch06 3.Group}{\coqdocrecord{Group}}.\coqdoceol
...
\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\{}}\coqdocvar{i} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{:}} \coqdocvar{G} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvar{G} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\&}} \coqdoceol
\coqdocindent{13.00em}
\coqdockw{\ensuremath{\forall}} \coqdocvar{a}, \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocvar{G} \coqdocvariable{a} (\coqdocvar{i} \coqdocvariable{a}) \coqdocnotation{=} \coqdocvar{G}\coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{\ensuremath{\times}}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocvar{G} (\coqdocvar{i} \coqdocvariable{a}) \coqdocvariable{a} \coqdocnotation{=} \coqdocvar{G}\coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\}\}}} \coqdoceol
\coqdocindent{12.50em}
\coqdocvar{\_}).\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{1.00em}
\coqdoctac{apply} \coqdoclemma{ex3\_21}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{destruct} \coqdocvar{G} \coqdockw{as} [\coqdocvar{G} \coqdocvar{m} \coqdocvar{e} \coqdocvar{HG}]. \coqdoctac{simpl} \coqdoctac{in} *.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} \coqref{Ch06 3.hprop inverse exists}{\coqdoclemma{hprop\_inverse\_exists}}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} \coqdocvar{HG}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocemptyline
...
\coqdocindent{1.00em}
\coqref{Ch06 3.IsMonoid}{\coqdocclass{IsMonoid}} (\coqdocconstructor{BuildhSet} (\coqexternalref{list}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{list}} \coqdocvariable{A}) (\coqref{Ch06 3.set list is set}{\coqdoclemma{set\_list\_is\_set}} \coqdocvar{\_} \coqdocvariable{HA})) (@\coqexternalref{app}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocdefinition{app}} \coqdocvariable{A}) \coqexternalref{nil}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{nil}}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Notation} \coqdef{Ch06 3.:16126}{"}{"}[ ]" := \coqexternalref{nil}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{nil}}.\coqdoceol
\coqdocnoindent
\coqdockw{Notation} \coqdef{Ch06 3.:16149}{"}{"}[ x ; .. ; y ]" := (\coqexternalref{cons}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{cons}} \coqdocvar{x} .. (\coqexternalref{cons}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{cons}} \coqdocvar{y} \coqexternalref{nil}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{nil}}) ..).\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocindent{1.00em}
\coqref{Ch06 3.MonoidHom}{\coqdocrecord{MonoidHom}} (\coqref{Ch06 3.BuildMonoid}{\coqdocconstructor{BuildMonoid}} (\coqdocconstructor{BuildhSet} (\coqexternalref{list}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{list}} \coqdocvariable{A}) (\coqref{Ch06 3.set list is set}{\coqdoclemma{set\_list\_is\_set}} \coqdocvar{\_} \coqdocvariable{HA})) \coqdoceol
\coqdocindent{12.50em}
\coqdocvar{\_} \coqdocvar{\_} \coqref{Ch06 3.set list is monoid}{\coqdoclemma{set\_list\_is\_monoid}}) \coqdoceol
\coqdocindent{6.00em}
\coqdocvariable{G} \coqdoceol
\coqdocindent{1.00em}
\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{(}}\coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{G}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{)}}\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdef{Ch06 3.hprop ismonoidhom}{hprop\_ismonoidhom}{\coqdoclemma{hprop\_ismonoidhom}} `\{\coqdocclass{Funext}\} \{\coqdocvar{A} \coqdocvar{B} : \coqref{Ch06 3.Monoid}{\coqdocrecord{Monoid}}\} (\coqdocvar{f} : \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{B}) \coqdoceol
\coqdocindent{1.00em}
: \coqdocabbreviation{IsHProp} (\coqref{Ch06 3.IsMonoidHom}{\coqdocclass{IsMonoidHom}} \coqdocvariable{f}).\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdef{Ch06 3.equiv path monoidhom}{equiv\_path\_monoidhom}{\coqdoclemma{equiv\_path\_monoidhom}} `\{\coqdocclass{Funext}\} \{\coqdocvar{A} \coqdocvar{B} : \coqref{Ch06 3.Monoid}{\coqdocrecord{Monoid}}\} \{\coqdocvar{f} \coqdocvar{g} : \coqref{Ch06 3.MonoidHom}{\coqdocrecord{MonoidHom}} \coqdocvariable{A} \coqdocvariable{B}\} :\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{6.00em}
(\coqdocvar{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvar{B}) \coqref{Ch06 3.IsMonoidHom}{\coqdocclass{IsMonoidHom}} \coqref{Ch06 3.hprop ismonoidhom}{\coqdoclemma{hprop\_ismonoidhom}}\coqdoceol
\coqdocindent{6.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdef{Ch06 3.list is free monoid}{list\_is\_free\_monoid}{\coqdoclemma{list\_is\_free\_monoid}} `\{\coqdocclass{Funext}\} (\coqdocvar{A} : \coqdockw{Type}) (\coqdocvar{HA} : \coqdocabbreviation{IsHSet} \coqdocvariable{A}) (\coqdocvar{G} : \coqref{Ch06 3.Monoid}{\coqdocrecord{Monoid}}) :\coqdoceol
\coqdocindent{1.00em}
\coqref{Ch06 3.MonoidHom}{\coqdocrecord{MonoidHom}} (\coqref{Ch06 3.BuildMonoid}{\coqdocconstructor{BuildMonoid}} ((\coqdocconstructor{BuildhSet} (\coqexternalref{list}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{list}} \coqdocvariable{A}) (\coqref{Ch06 3.set list is set}{\coqdoclemma{set\_list\_is\_set}} \coqdocvar{\_} \coqdocvariable{HA}))) \coqdoceol
\coqdocindent{12.50em}
\coqdocvar{\_} \coqdocvar{\_} \coqref{Ch06 3.set list is monoid}{\coqdoclemma{set\_list\_is\_monoid}}) \coqdoceol
...
\coqdocnotation{\ensuremath{\eqvsym}} \coqdoceol
\coqdocindent{6.00em}
\coqdocnotation{(}\coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{G}\coqdocnotation{)}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdef{Ch06 3.univ prop susp}{univ\_prop\_susp}{\coqdoclemma{univ\_prop\_susp}} `\{\coqdocclass{Funext}\} \{\coqdocvar{A} \coqdocvar{B} : \coqdockw{Type}\} :\coqdoceol
\coqdocindent{1.00em}
\coqdocnotation{(}\coqdocinductive{Susp} \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{B}\coqdocnotation{)} \coqdocnotation{\ensuremath{\eqvsym}} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\{}}\coqdocvar{bn} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{:}} \coqdocvariable{B} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\&}} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\{}}\coqdocvar{bs} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{:}} \coqdocvariable{B} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\&}} \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{(}}\coqdocvar{bn} \coqdocnotation{=} \coqdocvar{bs}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{)}}\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\}\}}}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{1.00em}
\coqdoctac{refine} (\coqdocnotation{(}@\coqdocdefinition{transport\_paths\_FlFr} \coqdocvar{\_} \coqdocvar{\_} \coqdocvar{\_} \coqdocvar{f} \coqdocvar{\_} \coqdocvar{\_} \coqdocvar{\_} \coqdocvar{\_}\coqdocnotation{)} \coqdocnotation{@} \coqdocvar{\_}).\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Lemma} \coqdef{Ch06 3.hset prod}{hset\_prod}{\coqdoclemma{hset\_prod}} : \coqdockw{\ensuremath{\forall}} \coqdocvar{A}, \coqdocabbreviation{IsHSet} \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdockw{\ensuremath{\forall}} \coqdocvar{B}, \coqdocabbreviation{IsHSet} \coqdocvariable{B} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocabbreviation{IsHSet} (\coqdocvariable{A} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{\ensuremath{\times}}} \coqdocvariable{B}).\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Lemma} \coqdef{Ch06 3.Exercise6 12.order partitions}{order\_partitions}{\coqdoclemma{order\_partitions}} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{n} \coqdocvar{m} : \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}}), \coqexternalref{:type scope:x '+' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocdefinition{le} \coqdocvariable{n} \coqdocvariable{m}\coqexternalref{:type scope:x '+' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}} \coqexternalref{:type scope:x '+' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{+}} \coqexternalref{:type scope:x '+' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocdefinition{lt} \coqdocvariable{m} \coqdocvariable{n}\coqexternalref{:type scope:x '+' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{3.00em}
\coqdoctac{left}. \coqdoctac{destruct} \coqdocvar{l} \coqdockw{as} [\coqdocvar{x} \coqdocvar{p}]. \coqdoctac{\ensuremath{\exists}} (\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvar{x}).\coqdoceol
\coqdocindent{3.00em}
\coqdoctac{simpl}. \coqdoctac{apply} (\coqdocdefinition{ap} \coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}}). \coqdoctac{apply} (\coqdocnotation{(}\coqdoclemma{plus\_n\_Sm} \coqdocvar{\_} \coqdocvar{\_}\coqdocnotation{)\^{}} \coqdocnotation{@} \coqdocvar{p}).\coqdoceol
\coqdocindent{3.00em}
...
\coqdocindent{4.00em}
\coqdoctac{right}. \coqdoctac{destruct} \coqdocvar{l0} \coqdockw{as} [\coqdocvar{x} \coqdocvar{p}]. \coqdoctac{\ensuremath{\exists}} \coqdocvar{x}. \coqdoctac{simpl}. \coqdoctac{apply} (\coqdocdefinition{ap} \coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}}). \coqdoctac{apply} \coqdocvar{p}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{Ch06 3.Exercise6 12.r}{r}{\coqdocdefinition{r}} : \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{\ensuremath{\times}}} \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{\ensuremath{\times}}} \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{1.00em}
\coqdoctac{apply} \coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqref{Ch06 3.Exercise6 12.monus}{\coqdocdefinition{monus}} \coqdocvar{a} \coqdocvar{b}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} \coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqref{Ch06 3.Exercise6 12.monus}{\coqdocdefinition{monus}} \coqdocvar{b} \coqdocvar{a}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{Ch06 3.Exercise6 12.int}{int}{\coqdocdefinition{int}} := \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\{}}\coqdocvar{x} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{:}} \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{\ensuremath{\times}}} \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\&}} \coqref{Ch06 3.Exercise6 12.r}{\coqdocdefinition{r}} \coqdocvar{x} \coqdocnotation{=} \coqdocvar{x}\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Specif}{\coqdocnotation{\}}}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{Ch06 3.Exercise6 12.int to nat 1 nat}{int\_to\_nat\_1\_nat}{\coqdocdefinition{int\_to\_nat\_1\_nat}} : \coqref{Ch06 3.Exercise6 12.int}{\coqdocdefinition{int}} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{(}}\coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} \coqexternalref{:type scope:x '+' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{+}} \coqdocinductive{Unit} \coqexternalref{:type scope:x '+' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{+}} \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{)}}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{Ch06 3.Exercise6 12.nat 1 nat to int}{nat\_1\_nat\_to\_int}{\coqdocdefinition{nat\_1\_nat\_to\_int}} : \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{(}}\coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} \coqexternalref{:type scope:x '+' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{+}} \coqdocinductive{Unit} \coqexternalref{:type scope:x '+' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{+}} \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{)}} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqref{Ch06 3.Exercise6 12.int}{\coqdocdefinition{int}} :=\coqdoceol
\coqdocindent{1.00em}
\coqdockw{fun} \coqdocvar{z} \ensuremath{\Rightarrow}\coqdoceol
\coqdocindent{2.00em}
\coqdockw{match} \coqdocvariable{z} \coqdockw{with}\coqdoceol
\coqdocindent{3.00em}
\ensuremath{|} \coqexternalref{inl}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{inl}} \coqdocvar{a} \ensuremath{\Rightarrow} \coqdockw{match} \coqdocvar{a} \coqdockw{with}\coqdoceol
\coqdocindent{9.50em}
\ensuremath{|} \coqexternalref{inl}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{inl}} \coqdocvar{n} \ensuremath{\Rightarrow} \coqdocnotation{(}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvar{n}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}\coqdocnotation{;} 1\coqdocnotation{)}\coqdoceol
\coqdocindent{9.50em}
\ensuremath{|} \coqexternalref{inr}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{inr}} \coqdocvar{\_} \ensuremath{\Rightarrow} \coqdocnotation{(}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}\coqdocnotation{;} 1\coqdocnotation{)}\coqdoceol
\coqdocindent{8.50em}
\coqdockw{end}\coqdoceol
\coqdocindent{3.00em}
\ensuremath{|} \coqexternalref{inr}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{inr}} \coqdocvar{n} \ensuremath{\Rightarrow} \coqdocnotation{(}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvar{n}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}\coqdocnotation{;} 1\coqdocnotation{)}\coqdoceol
\coqdocindent{2.00em}
\coqdockw{end}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdef{Ch06 3.Exercise6 12.ex6 12}{ex6\_12}{\coqdoclemma{ex6\_12}} : \coqref{Ch06 3.Exercise6 12.int}{\coqdocdefinition{int}} \coqdocnotation{\ensuremath{\eqvsym}} \coqdocnotation{(}\coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} \coqexternalref{:type scope:x '+' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{+}} \coqdocinductive{Unit} \coqexternalref{:type scope:x '+' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{+}} \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}}\coqdocnotation{)}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdoctac{reflexivity}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{unfold} \coqref{Ch06 3.Exercise6 12.int to nat 1 nat}{\coqdocdefinition{int\_to\_nat\_1\_nat}}. \coqdoctac{simpl}. \coqdoctac{repeat} \coqdocvar{f\_ap}. \coqdoctac{apply} \coqdocinstance{contr\_unit}. \coqdoctac{reflexivity}.\coqdoceol
\coqdocemptyline
\coqdocindent{1.00em}
...
\coqdocindent{2.00em}
\coqdocnotation{(}\coqref{Ch06 3.Exercise6 12.nat 1 nat to int}{\coqdocdefinition{nat\_1\_nat\_to\_int}} (\coqref{Ch06 3.Exercise6 12.int to nat 1 nat}{\coqdocdefinition{int\_to\_nat\_1\_nat}} \coqdocnotation{(}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocvar{a}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqdocvar{b}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}\coqdocnotation{;} \coqdocvar{p}\coqdocnotation{)})\coqdocnotation{).1} \coqdocnotation{=} \coqdocnotation{(}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocvar{a}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqdocvar{b}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}\coqdocnotation{;} \coqdocvar{p}\coqdocnotation{)}\coqdocnotation{.1}\coqdoceol
\coqdocindent{1.00em}
) \coqdockw{as} \coqdocvar{H}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{unfold} \coqref{Ch06 3.Exercise6 12.nat 1 nat to int}{\coqdocdefinition{nat\_1\_nat\_to\_int}}, \coqref{Ch06 3.Exercise6 12.int to nat 1 nat}{\coqdocdefinition{int\_to\_nat\_1\_nat}}, \coqref{Ch06 3.Exercise6 12.r}{\coqdocdefinition{r}} \coqdoctac{in} *. \coqdoctac{simpl} \coqdoctac{in} *.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{destruct} (\coqdoclemma{decidable\_paths\_nat} \coqdocvar{a} \coqdocvar{b}).\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{destruct} (\coqref{Ch06 3.Exercise6 12.order partitions}{\coqdoclemma{order\_partitions}} \coqdocvar{b} \coqdocvar{a}). \coqdoctac{refine} (\coqdocvar{\_} \coqdocnotation{@} \coqdocvar{p}).\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{apply} \coqdocdefinition{path\_prod}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{assert} (\coqdocvar{b} \coqdocnotation{=} \coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}). \coqdoctac{apply} \coqdocnotation{(}\coqdocdefinition{ap} \coqexternalref{snd}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocprojection{snd}} \coqdocvar{p}\coqdocnotation{)\^{}}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{assert} (\coqdocvar{a} \coqdocnotation{=} \coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}). \coqdoctac{apply} (\coqdocvar{p0} \coqdocnotation{@} \coqdocvar{X}).\coqdoceol
\coqdocindent{2.00em}
...
\coqdoctac{reflexivity}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{assert} (\coqdocvar{a} \coqdocnotation{=} \coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}). \coqdoctac{apply} \coqdocnotation{(}\coqdocdefinition{ap} \coqexternalref{fst}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocprojection{fst}} \coqdocvar{p}\coqdocnotation{)\^{}}. \coqdoctac{assert} (\coqdocvar{b} \coqdocnotation{=} \coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}). \coqdoctac{apply} (\coqdocvar{p0}\coqdocnotation{\^{}} \coqdocnotation{@} \coqdocvar{X}). \coqdoctac{simpl}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{apply} \coqdocdefinition{path\_prod}. \coqdoctac{apply} \coqdocvar{X}\coqdocnotation{\^{}}. \coqdoctac{apply} \coqdocvar{X0}\coqdocnotation{\^{}}.\coqdoceol
\coqdocemptyline
\coqdocindent{1.00em}
\coqdoctac{destruct} (\coqref{Ch06 3.Exercise6 12.order partitions}{\coqdoclemma{order\_partitions}} \coqdocvar{b} \coqdocvar{a}); \coqdoctac{refine} (\coqdocvar{\_} \coqdocnotation{@} \coqdocvar{p});\coqdoceol
\coqdocindent{2.00em}
...
\coqdocindent{2.00em}
\coqdoctac{assert} (\coqdocvar{a} \coqdocnotation{=} \coqdocvar{b}). \coqdoctac{refine} (\coqdocnotation{(}\coqdocdefinition{ap} \coqexternalref{fst}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocprojection{fst}} \coqdocvar{p}\coqdocnotation{)\^{}} \coqdocnotation{@} \coqdocvar{H}\coqdocnotation{\^{}} \coqdocnotation{@} \coqdocnotation{(}\coqdocdefinition{ap} \coqexternalref{snd}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocprojection{snd}} \coqdocvar{p}\coqdocnotation{)}). \coqdoctac{apply} \coqdocvar{n} \coqdoctac{in} \coqdocvar{X}.\coqdoceol
\coqdocindent{2.00em}
...
\coqdocindent{2.00em}
\coqdoctac{assert} (\coqdocabbreviation{IsHSet} (\coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocnotation{\ensuremath{\times}}} \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl4/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}})) \coqdockw{as} \coqdocvar{Hn}. \coqdoctac{apply} \coqref{Ch06 3.Exercise6 12.hset prod}{\coqdoclemma{hset\_prod}}; \coqdoctac{apply} \coqref{Ch06 3.Exercise6 12.hset nat}{\coqdoclemma{hset\_nat}}.\coqdoceol
\coqdocindent{2.00em}
