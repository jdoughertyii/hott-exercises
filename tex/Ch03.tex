...
$\LEM{i+1}$\coqdocindent{0.50em}
holds,\coqdocindent{0.50em}
then\coqdocindent{0.50em}
$\LEM{i}$\coqdocindent{0.50em}
holds\coqdocindent{0.50em}
as\coqdocindent{0.50em}
well.\coqdocindent{1.00em}
For\coqdocindent{0.50em}
suppose\coqdocindent{0.50em}
that\coqdoceol
$A : \UU_{i}$\coqdocindent{0.50em}
and\coqdocindent{0.50em}
$p : \isprop(A)$.\coqdocindent{1.00em}
Then\coqdocindent{0.50em}
we\coqdocindent{0.50em}
also\coqdocindent{0.50em}
have\coqdocindent{0.50em}
$A :
\UU_{i+1}$,\coqdocindent{0.50em}
so\coqdocindent{0.50em}
$\LEM{i+1}(A, p) : A + \lnot A$,\coqdocindent{0.50em}
establishing\coqdoceol
$\LEM{i}$.\coqdocindent{1.00em}
...
then,\coqdocindent{0.50em}
$\prop_{\UU_{i}} \eqvsym
\bool \eqvsym \prop_{\UU_{i+1}}$.\coqdoceol
\coqdoceol
...
the\coqdocindent{0.50em}
user\coqdocindent{0.50em}
access\coqdocindent{0.50em}
the\coqdocindent{0.50em}
\coqdockw{Type}$_{i}$\coqdocindent{0.50em}
hierarchy,\coqdoceol
there's\coqdocindent{0.50em}
not\coqdocindent{0.50em}
much\coqdocindent{0.50em}
to\coqdocindent{0.50em}
do\coqdocindent{0.50em}
here.\coqdocindent{1.00em}
...
by\coqdoceol
contemplation''\coqdocindent{0.50em}
anyway.\coqdoceol
\end{coqdoccomment}
\coqdoceol
\coqdocemptyline
...
\coqdocindent{1.00em}
\coqdoctac{apply} (@\coqdocdefinition{transport\_arrow} \coqdockw{Type} (\coqdockw{fun} \coqdocvar{A} \ensuremath{\Rightarrow} \coqref{Ch03.Brck}{\coqdocabbreviation{Brck}} \coqdocvariable{A}) \coqdocabbreviation{idmap}).\coqdoceol
\coqdocindent{1.00em}
...
\coqdocnoindent
\coqdockw{Infix} \coqdef{Ch03.:nat scope:x '<=' x}{"}{"}\ensuremath{\le}" := \coqref{Ch03.le}{\coqdocdefinition{le}} : \coqdocvar{nat\_scope}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocnoindent
\coqdockw{Infix} \coqdef{Ch03.:nat scope:x '<' x}{"}{"}<" := \coqref{Ch03.lt}{\coqdocdefinition{lt}} : \coqdocvar{nat\_scope}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Infix} \coqdef{Ch03.:nat scope:x '<=?' x}{"}{"}<=?" := \coqref{Ch03.leb}{\coqdocdefinition{leb}} (\coqdoctac{at} \coqdockw{level} 70) : \coqdocvar{nat\_scope}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocindent{1.00em}
\coqdocdefinition{transport} (\coqdockw{fun} \coqdocvar{\_} \ensuremath{\Rightarrow} \coqref{Ch03.nat code}{\coqdocdefinition{nat\_code}} \coqdocvariable{n} \coqdocvar{\_}) \coqdocvariable{p} (\coqref{Ch03.nat r}{\coqdocdefinition{nat\_r}} \coqdocvariable{n}).\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{intros}. \coqdoctac{refine} (\coqdocdefinition{equiv\_adjointify} (\coqref{Ch03.nat decode}{\coqdocdefinition{nat\_decode}} \coqdocvar{n} \coqdocvar{m}) (\coqref{Ch03.nat encode}{\coqdocdefinition{nat\_encode}} \coqdocvar{n} \coqdocvar{m}) \coqdocvar{\_} \coqdocvar{\_});\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{1.00em}
\coqdoctac{intro} \coqdocvar{p}. \coqdoctac{simpl}. \coqdoctac{unfold} \coqref{Ch03.nat encode}{\coqdocdefinition{nat\_encode}}. \coqdoctac{rewrite} \ensuremath{\leftarrow} \coqdoclemma{transport\_compose}. \coqdoctac{simpl}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{change} (\coqdocdefinition{transport} (\coqdockw{fun} \coqdocvar{x} : \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} \ensuremath{\Rightarrow} \coqref{Ch03.nat code}{\coqdocdefinition{nat\_code}} \coqdocvar{n} \coqdocvariable{x}) (\coqref{Ch03.nat decode}{\coqdocdefinition{nat\_decode}} \coqdocvar{n} \coqdocvar{m} \coqdocvar{p}) (\coqref{Ch03.nat r}{\coqdocdefinition{nat\_r}} \coqdocvar{n}))\coqdoceol
\coqdocindent{4.50em}
\coqdockw{with} (\coqref{Ch03.nat encode}{\coqdocdefinition{nat\_encode}} \coqdocvar{n} \coqdocvar{m} (\coqref{Ch03.nat decode}{\coqdocdefinition{nat\_decode}} \coqdocvar{n} \coqdocvar{m} \coqdocvar{p})).\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{2.00em}
\coqdoctac{try}(\coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{H}; \coqdocvar{contradiction}).\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{H}.\coqdoceol
\coqdocindent{2.00em}
...
\coqdocindent{2.00em}
\coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{H}. \coqdoctac{apply} \coqdocvar{H}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocindent{2.00em}
\coqdoctac{intro} \coqdocvar{p}. \coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{p}. \coqdocvar{contradiction}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{intro} \coqdocvar{p}. \coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{p}. \coqdoctac{simpl} \coqdoctac{in} \coqdocvar{p}. \coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{p}.\coqdoceol
\coqdocindent{3.00em}
\coqdocvar{contradiction}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
...
\coqdocindent{1.00em}
\coqdoctac{simpl} \coqdoctac{in} \coqdocvar{H}. \coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{H}. \coqdocvar{contradiction}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocindent{2.00em}
\coqdoctac{destruct} \coqdocvar{H}. \coqdoctac{apply} \coqref{Ch03.sum Ol}{\coqdoclemma{sum\_Ol}} \coqdoctac{in} \coqdocvar{p}. \coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{p}. \coqdocvar{contradiction}.\coqdoceol
\coqdocindent{1.00em}
- \coqdoctac{split}.\coqdoceol
\coqdocindent{2.00em}
...
\coqdoctac{reflexivity}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{intros}. \coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{p2}. \coqdocvar{contradiction}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{intros}. \coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{p1}. \coqdocvar{contradiction}.\coqdoceol
\coqdocindent{2.00em}
...
\coqdocindent{3.00em}
\coqdoctac{right}. \coqdoctac{intro} \coqdocvar{p}. \coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{p}. \coqdocvar{contradiction}.\coqdoceol
\coqdocindent{3.00em}
\coqdoctac{right}. \coqdoctac{intro} \coqdocvar{p}. \coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{p}. \coqdocvar{contradiction}.\coqdoceol
\coqdocindent{3.00em}
...
\coqdocindent{1.00em}
\coqdoctac{intros}. \coqdoctac{intro} \coqdocvar{p}. \coqdoctac{apply} \coqref{Ch03.le antisymmetric}{\coqdoclemma{le\_antisymmetric}} \coqdoctac{in} \coqdocvar{H0}. \coqdoctac{symmetry} \coqdoctac{in} \coqdocvar{H0}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdoctac{induction} \coqdocvar{n}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{intros} \coqdocvar{m} \coqdocvar{p}. \coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{p}. \coqdocvar{contradiction}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{1.00em}
\coqdoctac{apply} \coqref{Ch03.Theorem2131}{\coqdoclemma{Theorem2131}} \coqdoctac{in} \coqdocvar{q}. \coqdocvar{contradiction}.\coqdoceol
\coqdocindent{1.00em}
