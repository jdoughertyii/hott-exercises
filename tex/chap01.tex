...
\nwenddocs{}\nwbegincode{2}\moddef{ex01.v}\endmoddef
\PY{k+kn}{Definition} \PY{n}{compose} \PY{o}{\PYZob{}}\PY{n+nc}{A} \PY{n+nc}{B} \PY{n+nc}{C}\PY{o}{:}\PY{k+kt}{Type}\PY{o}{\PYZcb{}} \PY{o}{(}\PY{n}{g} \PY{o}{:} \PY{n+nc}{B} \PY{o}{\mLA\ensuremath{\rightarrow}\mRA} \PY{n+nc}{C}\PY{o}{)} \PY{o}{(}\PY{n}{f} \PY{o}{:} \PY{n+nc}{A} \PY{o}{\mLA\ensuremath{\rightarrow}\mRA} \PY{n+nc}{B}\PY{o}{)} \PY{o}{:=}
    \PY{k}{fun} \PY{n}{x} \PY{o}{\mLA\ensuremath{\Rightarrow}\mRA} \PY{n}{g} \PY{o}{(}\PY{n}{f} \PY{n}{x}\PY{o}{)}\PY{o}{.}

\PY{k+kn}{Theorem} \PY{n}{compose\PYZus{}assoc} \PY{o}{:} \PY{k}{forall} \PY{o}{(}\PY{n+nc}{A} \PY{n+nc}{B} \PY{n+nc}{C} \PY{n+nc}{D} \PY{o}{:} \PY{k+kt}{Type}\PY{o}{)} \PY{o}{(}\PY{n}{f} \PY{o}{:} \PY{n+nc}{A} \PY{o}{\mLA\ensuremath{\rightarrow}\mRA} \PY{n+nc}{B}\PY{o}{)} \PY{o}{(}\PY{n}{g} \PY{o}{:} \PY{n+nc}{B}\PY{o}{\mLA\ensuremath{\rightarrow}\mRA} \PY{n+nc}{C}\PY{o}{)} \PY{o}{(}\PY{n}{h} \PY{o}{:} \PY{n+nc}{C} \PY{o}{\mLA\ensuremath{\rightarrow}\mRA} \PY{n+nc}{D}\PY{o}{)}\PY{o}{,}
    \PY{n}{compose} \PY{n}{h} \PY{o}{(}\PY{n}{compose} \PY{n}{g} \PY{n}{f}\PY{o}{)} \PY{o}{=} \PY{n}{compose} \PY{o}{(}\PY{n}{compose} \PY{n}{h} \PY{n}{g}\PY{o}{)} \PY{n}{f}\PY{o}{.}
\PY{k+kn}{Proof}\PY{o}{.}
  \PY{k}{trivial}\PY{o}{.}
\PY{k+kn}{Qed}\PY{o}{.}
\nwendcode{}\nwbegindocs{3}%DONE
...
\nwenddocs{}\nwbegincode{4}\moddef{ex02a.v}\endmoddef
\PY{k+kn}{Definition} \PY{n}{recprod} \PY{o}{(}\PY{n+nc}{C} \PY{o}{:} \PY{k+kt}{Type}\PY{o}{)} \PY{o}{(}\PY{n}{g} \PY{o}{:} \PY{n+nc}{A} \PY{o}{\mLA\ensuremath{\rightarrow}\mRA} \PY{n+nc}{B} \PY{o}{\mLA\ensuremath{\rightarrow}\mRA} \PY{n+nc}{C}\PY{o}{)} \PY{o}{(}\PY{n}{p} \PY{o}{:} \PY{n+nc}{A} \PY{o}{*} \PY{n+nc}{B}\PY{o}{)} \PY{o}{:=}
    \PY{n}{g} \PY{o}{(}\PY{n}{fst} \PY{n}{p}\PY{o}{)} \PY{o}{(}\PY{n}{snd} \PY{n}{p}\PY{o}{)}\PY{o}{.}

\nwendcode{}\nwbegindocs{5}We must then show that
\begin{align*}
...
\nwenddocs{}\nwbegincode{6}\moddef{ex02a.v}\plusendmoddef
\PY{k+kn}{Goal} \PY{k}{forall} \PY{n+nc}{C} \PY{n}{g} \PY{n}{a} \PY{n}{b}\PY{o}{,} \PY{n}{recprod} \PY{n+nc}{C} \PY{n}{g} \PY{o}{(}\PY{n}{a}\PY{o}{,} \PY{n}{b}\PY{o}{)} \PY{o}{=} \PY{n}{g} \PY{n}{a} \PY{n}{b}\PY{o}{.} \PY{k}{trivial}\PY{o}{.} \PY{k+kn}{Qed}\PY{o}{.}

\nwendcode{}\nwbegindocs{7}Now for the $\Sigma$-types.  Here we have a projection
\[
...
\nwenddocs{}\nwbegincode{8}\moddef{ex02b.v}\endmoddef
\PY{k+kn}{Definition} \PY{n}{recsm} \PY{o}{(}\PY{n+nc}{C} \PY{o}{:} \PY{k+kt}{Type}\PY{o}{)} \PY{o}{(}\PY{n}{g} \PY{o}{:} \PY{k}{forall} \PY{o}{(}\PY{n}{x} \PY{o}{:} \PY{n+nc}{A}\PY{o}{)}\PY{o}{,} \PY{n+nc}{B} \PY{n}{x} \PY{o}{\mLA\ensuremath{\rightarrow}\mRA} \PY{n+nc}{C}\PY{o}{)} \PY{o}{(}\PY{n}{p} \PY{o}{:} \PY{k}{exists} \PY{o}{(}\PY{n}{x} \PY{o}{:} \PY{n+nc}{A}\PY{o}{)}\PY{o}{,} \PY{n+nc}{B} \PY{n}{x}\PY{o}{)} \PY{o}{:=}
    \PY{n}{g} \PY{o}{(}\PY{n}{projT1} \PY{n}{p}\PY{o}{)} \PY{o}{(}\PY{n}{projT2} \PY{n}{p}\PY{o}{)}\PY{o}{.}

\nwendcode{}\nwbegindocs{9}We then verify that
\begin{align*}
...
\nwenddocs{}\nwbegincode{10}\moddef{ex02b.v}\plusendmoddef
\PY{k+kn}{Goal} \PY{k}{forall} \PY{n+nc}{C} \PY{n}{g} \PY{n}{a} \PY{n}{b}\PY{o}{,} \PY{n}{recsm} \PY{n+nc}{C} \PY{n}{g} \PY{o}{(}\PY{n}{a}\PY{o}{;} \PY{n}{b}\PY{o}{)} \PY{o}{=} \PY{n}{g} \PY{n}{a} \PY{n}{b}\PY{o}{.} \PY{k}{trivial}\PY{o}{.} \PY{k+kn}{Qed}\PY{o}{.}

\nwendcode{}\nwbegindocs{11}\exer{1.3}{56} Derive the induction principle for products $\ind{A \times B}$
...
\nwenddocs{}\nwbegincode{12}\moddef{ex03a.v}\endmoddef
\PY{k+kn}{Definition} \PY{n}{uppt} \PY{o}{(}\PY{n}{x} \PY{o}{:} \PY{n+nc}{A} \PY{o}{*} \PY{n+nc}{B}\PY{o}{)} \PY{o}{:} \PY{o}{(}\PY{n}{fst} \PY{n}{x}\PY{o}{,} \PY{n}{snd} \PY{n}{x}\PY{o}{)} \PY{o}{=} \PY{n}{x}\PY{o}{.}
  \PY{k}{destruct} \PY{n}{x}\PY{o}{;} \PY{k+kp}{reflexivity}\PY{o}{.}
\PY{k+kn}{Defined}\PY{o}{.}

\PY{k+kn}{Definition} \PY{n}{indprd} \PY{o}{(}\PY{n+nc}{C} \PY{o}{:} \PY{n+nc}{A} \PY{o}{*} \PY{n+nc}{B} \PY{o}{\mLA\ensuremath{\rightarrow}\mRA} \PY{k+kt}{Type}\PY{o}{)} \PY{o}{(}\PY{n}{g} \PY{o}{:} \PY{k}{forall} \PY{o}{(}\PY{n}{x}\PY{o}{:}\PY{n+nc}{A}\PY{o}{)} \PY{o}{(}\PY{n}{y}\PY{o}{:}\PY{n+nc}{B}\PY{o}{)}\PY{o}{,} \PY{n+nc}{C} \PY{o}{(}\PY{n}{x}\PY{o}{,} \PY{n}{y}\PY{o}{)}\PY{o}{)} \PY{o}{(}\PY{n}{z} \PY{o}{:} \PY{n+nc}{A} \PY{o}{*} \PY{n+nc}{B}\PY{o}{)} \PY{o}{:=}
      \PY{o}{(}\PY{n}{uppt} \PY{n}{z}\PY{o}{)} \PY{o}{\PYZsh{}} \PY{o}{(}\PY{n}{g} \PY{o}{(}\PY{n}{fst} \PY{n}{z}\PY{o}{)} \PY{o}{(}\PY{n}{snd} \PY{n}{z}\PY{o}{)}\PY{o}{)}\PY{o}{.}

\nwendcode{}\nwbegindocs{13}We now have to show that
\[
...
\nwenddocs{}\nwbegincode{14}\moddef{ex03a.v}\plusendmoddef
\PY{k+kn}{Goal} \PY{k}{forall} \PY{n+nc}{C} \PY{n}{g} \PY{n}{a} \PY{n}{b}\PY{o}{,} \PY{n}{indprd} \PY{n+nc}{C} \PY{n}{g} \PY{o}{(}\PY{n}{a}\PY{o}{,} \PY{n}{b}\PY{o}{)} \PY{o}{=} \PY{n}{g} \PY{n}{a} \PY{n}{b}\PY{o}{.} \PY{k}{trivial}\PY{o}{.} \PY{k+kn}{Qed}\PY{o}{.}
...
\nwenddocs{}\nwbegincode{16}\moddef{ex03b.v}\endmoddef
\PY{k+kn}{Definition} \PY{n}{upst} \PY{o}{(}\PY{n}{p} \PY{o}{:} \PY{o}{\PYZob{}}\PY{n}{x}\PY{o}{:}\PY{n+nc}{A} \PY{o}{\PYZam{}} \PY{n+nc}{B} \PY{n}{x}\PY{o}{\PYZcb{}}\PY{o}{)} \PY{o}{:} \PY{o}{(}\PY{n}{projT1} \PY{n}{p}\PY{o}{;} \PY{n}{projT2} \PY{n}{p}\PY{o}{)} \PY{o}{=} \PY{n}{p}\PY{o}{.}
  \PY{k}{destruct} \PY{n}{p}\PY{o}{;} \PY{k+kp}{reflexivity}\PY{o}{.}
\PY{k+kn}{Defined}\PY{o}{.}

\PY{k+kn}{Definition} \PY{n}{indsm} \PY{o}{(}\PY{n+nc}{C} \PY{o}{:} \PY{o}{\PYZob{}}\PY{n}{x}\PY{o}{:}\PY{n+nc}{A} \PY{o}{\PYZam{}} \PY{n+nc}{B} \PY{n}{x}\PY{o}{\PYZcb{}} \PY{o}{\mLA\ensuremath{\rightarrow}\mRA} \PY{k+kt}{Type}\PY{o}{)} \PY{o}{(}\PY{n}{g} \PY{o}{:} \PY{k}{forall} \PY{o}{(}\PY{n}{a}\PY{o}{:}\PY{n+nc}{A}\PY{o}{)} \PY{o}{(}\PY{n}{b}\PY{o}{:}\PY{n+nc}{B} \PY{n}{a}\PY{o}{)}\PY{o}{,} \PY{n+nc}{C} \PY{o}{(}\PY{n}{a}\PY{o}{;} \PY{n}{b}\PY{o}{)}\PY{o}{)} 
                 \PY{o}{(}\PY{n}{p} \PY{o}{:} \PY{o}{\PYZob{}}\PY{n}{x}\PY{o}{:}\PY{n+nc}{A} \PY{o}{\PYZam{}} \PY{n+nc}{B} \PY{n}{x}\PY{o}{\PYZcb{}}\PY{o}{)} \PY{o}{:=}
     \PY{o}{(}\PY{n}{upst} \PY{n}{p}\PY{o}{)} \PY{o}{\PYZsh{}} \PY{o}{(}\PY{n}{g} \PY{o}{(}\PY{n}{projT1} \PY{n}{p}\PY{o}{)} \PY{o}{(}\PY{n}{projT2} \PY{n}{p}\PY{o}{)}\PY{o}{)}\PY{o}{.}

\nwendcode{}\nwbegindocs{17}Now we must verify that
\[
...
\nwenddocs{}\nwbegincode{18}\moddef{ex03b.v}\plusendmoddef
\PY{k+kn}{Goal} \PY{k}{forall} \PY{n+nc}{C} \PY{n}{g} \PY{n}{a} \PY{n}{b}\PY{o}{,} \PY{n}{indsm} \PY{n+nc}{C} \PY{n}{g} \PY{o}{(}\PY{n}{a}\PY{o}{;} \PY{n}{b}\PY{o}{)} \PY{o}{=} \PY{n}{g} \PY{n}{a} \PY{n}{b}\PY{o}{.} \PY{k}{trivial}\PY{o}{.} \PY{k+kn}{Qed}\PY{o}{.}

\nwendcode{}\nwbegindocs{19}\exer{1.4}{56}  Assuming as given only the \emph{iterator} for natural numbers
\[
  \ite : 
...
\nwenddocs{}\nwbegincode{20}\moddef{chap01.v}\endmoddef
\PY{k+kn}{Require} \PY{k+kn}{Import} \PY{n+nn}{HoTT}\PY{p}{.}

\PY{n+nc}{Section} \PY{n+nn}{Exercise1}\PY{p}{.}

  \LA{}ex01.v\RA{}
\PY{n+nc}{End} \PY{n+nn}{Exercise1}\PY{p}{.}

\PY{n+nc}{Section} \PY{n+nn}{Exercise2a}\PY{p}{.}
  \PY{n+nc}{Context} \PY{o}{\PYZob{}}\PY{n+nc}{A} \PY{n+nc}{B} \PY{o}{:} \PY{k+kt}{Type}\PY{o}{\PYZcb{}}\PY{o}{.}

  \LA{}ex02a.v\RA{}
\PY{k+kn}{End} \PY{n+nn}{Exercise2a}\PY{p}{.}

\PY{n+nc}{Section} \PY{n+nn}{Exercise2b}\PY{p}{.}
  \PY{n+nc}{Context} \PY{o}{\PYZob{}}\PY{n+nc}{A} \PY{o}{:} \PY{k+kt}{Type}\PY{o}{\PYZcb{}}\PY{o}{.}
  \PY{n+nc}{Context} \PY{o}{\PYZob{}}\PY{n+nc}{B} \PY{o}{:} \PY{n+nc}{A} \PY{o}{\mLA\ensuremath{\rightarrow}\mRA} \PY{k+kt}{Type}\PY{o}{\PYZcb{}}\PY{o}{.}

  \LA{}ex02b.v\RA{}
\PY{k+kn}{End} \PY{n+nn}{Exercise2b}\PY{p}{.}

\PY{n+nc}{Section} \PY{n+nn}{Exercise3a}\PY{p}{.}
  \PY{n+nc}{Context} \PY{o}{\PYZob{}}\PY{n+nc}{A} \PY{n+nc}{B} \PY{o}{:} \PY{k+kt}{Type}\PY{o}{\PYZcb{}}\PY{o}{.}

  \LA{}ex03a.v\RA{}
\PY{k+kn}{End} \PY{n+nn}{Exercise3a}\PY{p}{.}

\PY{n+nc}{Section} \PY{n+nn}{Exercise3b}\PY{p}{.}
  \PY{n+nc}{Context} \PY{o}{\PYZob{}}\PY{n+nc}{A} \PY{o}{:} \PY{k+kt}{Type}\PY{o}{\PYZcb{}}\PY{o}{.}
  \PY{n+nc}{Context} \PY{o}{\PYZob{}}\PY{n+nc}{B} \PY{o}{:} \PY{n+nc}{A} \PY{o}{\mLA\ensuremath{\rightarrow}\mRA} \PY{k+kt}{Type}\PY{o}{\PYZcb{}}\PY{o}{.}

  \LA{}ex03b.v\RA{}
\PY{k+kn}{End} \PY{n+nn}{Exercise3b}\PY{p}{.}
\nwendcode{}
