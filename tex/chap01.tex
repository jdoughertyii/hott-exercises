...
\nwenddocs{}\nwbegincode{2}\moddef{chap01.v}\endmoddef
...
\nwenddocs{}\nwbegincode{4}\moddef{chap01.v}\plusendmoddef
\PY{k+kn}{Section} \PY{n+nn}{Exercise1}\PY{p}{.}

\PY{n+nc}{Definition} \PY{n}{compose} \PY{o}{\PYZob{}}\PY{n+nc}{A} \PY{n+nc}{B} \PY{n+nc}{C}\PY{o}{:}\PY{k+kt}{Type}\PY{o}{\PYZcb{}} \PY{o}{(}\PY{n}{g} \PY{o}{:} \PY{n+nc}{B} \PY{o}{\PYZhy{}\PYZgt{}} \PY{n+nc}{C}\PY{o}{)} \PY{o}{(}\PY{n}{f} \PY{o}{:} \PY{n+nc}{A} \PY{o}{\PYZhy{}\PYZgt{}} \PY{n+nc}{B}\PY{o}{)} \PY{o}{:=}
    \PY{k}{fun} \PY{n}{x} \PY{o}{=\PYZgt{}} \PY{n}{g} \PY{o}{(}\PY{n}{f} \PY{n}{x}\PY{o}{)}\PY{o}{.}

\PY{k+kn}{Theorem} \PY{n}{compose\PYZus{}assoc} \PY{o}{:} \PY{k}{forall} \PY{o}{(}\PY{n+nc}{A} \PY{n+nc}{B} \PY{n+nc}{C} \PY{n+nc}{D} \PY{o}{:} \PY{k+kt}{Type}\PY{o}{)} \PY{o}{(}\PY{n}{f} \PY{o}{:} \PY{n+nc}{A} \PY{o}{\PYZhy{}\PYZgt{}} \PY{n+nc}{B}\PY{o}{)} \PY{o}{(}\PY{n}{g} \PY{o}{:} \PY{n+nc}{B}\PY{o}{\PYZhy{}\PYZgt{}} \PY{n+nc}{C}\PY{o}{)} \PY{o}{(}\PY{n}{h} \PY{o}{:} \PY{n+nc}{C} \PY{o}{\PYZhy{}\PYZgt{}} \PY{n+nc}{D}\PY{o}{)}\PY{o}{,}
...
\PY{k+kn}{End} \PY{n+nn}{Exercise1}\PY{p}{.}
...
\nwenddocs{}\nwbegincode{6}\moddef{chap01.v}\plusendmoddef
\PY{k+kn}{Section} \PY{n+nn}{Exercise2\PYZus{}prd}\PY{p}{.}

\PY{n+nc}{Variable} \PY{n+nc}{A} \PY{n+nc}{B} \PY{o}{:} \PY{k+kt}{Type}\PY{o}{.}

\PY{k+kn}{Definition} \PY{n}{recprod} \PY{o}{(}\PY{n+nc}{C} \PY{o}{:} \PY{k+kt}{Type}\PY{o}{)} \PY{o}{(}\PY{n}{g} \PY{o}{:} \PY{n+nc}{A} \PY{o}{\PYZhy{}\PYZgt{}} \PY{n+nc}{B} \PY{o}{\PYZhy{}\PYZgt{}} \PY{n+nc}{C}\PY{o}{)} \PY{o}{(}\PY{n}{p} \PY{o}{:} \PY{n+nc}{A} \PY{o}{*} \PY{n+nc}{B}\PY{o}{)} \PY{o}{:=}
    \PY{n}{g} \PY{o}{(}\PY{n}{fst} \PY{n}{p}\PY{o}{)} \PY{o}{(}\PY{n}{snd} \PY{n}{p}\PY{o}{)}\PY{o}{.}

\PY{k+kn}{Goal} \PY{n}{recprod} \PY{n+nc}{A} \PY{o}{(}\PY{k}{fun} \PY{n}{a} \PY{o}{=\PYZgt{}} \PY{k}{fun} \PY{n}{b} \PY{o}{=\PYZgt{}} \PY{n}{a}\PY{o}{)} \PY{o}{=} \PY{n}{fst}\PY{o}{.} \PY{k}{trivial}\PY{o}{.} \PY{k+kn}{Qed}\PY{o}{.}
\PY{k+kn}{Goal} \PY{n}{recprod} \PY{n+nc}{B} \PY{o}{(}\PY{k}{fun} \PY{n}{a} \PY{o}{=\PYZgt{}} \PY{k}{fun} \PY{n}{b} \PY{o}{=\PYZgt{}} \PY{n}{b}\PY{o}{)} \PY{o}{=} \PY{n}{snd}\PY{o}{.} \PY{k}{trivial}\PY{o}{.} \PY{k+kn}{Qed}\PY{o}{.}

\PY{k+kn}{End} \PY{n+nn}{Exercise2\PYZus{}prd}\PY{p}{.}

\PY{n+nc}{Section} \PY{n+nn}{Exercise2\PYZus{}sm}\PY{p}{.}

\PY{n+nc}{Variable} \PY{n+nc}{A} \PY{o}{:} \PY{k+kt}{Type}\PY{o}{.}
\PY{k+kn}{Variable} \PY{n+nc}{B} \PY{o}{:} \PY{n+nc}{A} \PY{o}{\PYZhy{}\PYZgt{}} \PY{k+kt}{Type}\PY{o}{.}

\PY{k+kn}{Definition} \PY{n}{recsm} \PY{o}{(}\PY{n+nc}{C} \PY{o}{:} \PY{k+kt}{Type}\PY{o}{)} \PY{o}{(}\PY{n}{g} \PY{o}{:} \PY{k}{forall} \PY{o}{(}\PY{n}{x} \PY{o}{:} \PY{n+nc}{A}\PY{o}{)}\PY{o}{,} \PY{n+nc}{B} \PY{n}{x} \PY{o}{\PYZhy{}\PYZgt{}} \PY{n+nc}{C}\PY{o}{)} \PY{o}{(}\PY{n}{p} \PY{o}{:} \PY{k}{exists} \PY{o}{(}\PY{n}{x} \PY{o}{:} \PY{n+nc}{A}\PY{o}{)}\PY{o}{,} \PY{n+nc}{B} \PY{n}{x}\PY{o}{)} \PY{o}{:=}
    \PY{n}{g} \PY{o}{(}\PY{n}{projT1} \PY{n}{p}\PY{o}{)} \PY{o}{(}\PY{n}{projT2} \PY{n}{p}\PY{o}{)}\PY{o}{.}

\PY{k+kn}{End} \PY{n+nn}{Exercise2\PYZus{}sm}\PY{p}{.}

\nwendcode{}\nwbegindocs{7}We must then show that
\begin{align*}
