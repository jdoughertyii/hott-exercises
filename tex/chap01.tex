...
to Coq from the HoTT repo} is assumed.  Each exercise has its own \coqdockw{Section} in
the Coq file, so \coqdockw{Context} declarations don't extend beyond the exercise---and sometimes they're even more restricted than that.
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Goal} \coqdockw{\ensuremath{\forall}} \coqdocvar{C} \coqdocvar{g} \coqdocvar{a} \coqdocvar{b}, \coqref{chap01.recsm}{\coqdocdefinition{recsm}} \coqdocvariable{C} \coqdocvariable{g} \coqdocnotation{(}\coqdocvariable{a}\coqdocnotation{;} \coqdocvariable{b}\coqdocnotation{)} \coqdocnotation{=} \coqdocvariable{g} \coqdocvariable{a} \coqdocvariable{b}. \coqdoceol
\coqdocemptyline
\coqdocemptyline
\end{coqdoccode}
\exer{1.3}{56} 
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Goal} \coqdockw{\ensuremath{\forall}} \coqdocvar{C} \coqdocvar{g} \coqdocvar{a} \coqdocvar{b}, \coqref{chap01.indsm}{\coqdocdefinition{indsm}} \coqdocvariable{C} \coqdocvariable{g} \coqdocnotation{(}\coqdocvariable{a}\coqdocnotation{;} \coqdocvariable{b}\coqdocnotation{)} \coqdocnotation{=} \coqdocvariable{g} \coqdocvariable{a} \coqdocvariable{b}. \coqdoceol
\coqdocemptyline
\coqdocemptyline
\end{coqdoccode}
\exer{1.4}{56}  
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Goal} \coqdockw{\ensuremath{\forall}} \coqdocvar{C} \coqdocvar{c0} \coqdocvar{cs}, \coqref{chap01.Phi}{\coqdocdefinition{Phi}} \coqdocvariable{C} \coqdocvariable{c0} \coqdocvariable{cs} 0 \coqdocnotation{=} \coqdocvariable{c0}. \coqdoceol
\coqdocemptyline
\end{coqdoccode}
\noindent
...
\[
  ...
  \right)
\]
and, in Coq, we use \coqexternalref{sigT rect}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocabbreviation{sigT\_rect}}, which is the built-in
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Goal} \coqdockw{\ensuremath{\forall}} \coqdocvar{C} \coqdocvar{g0} \coqdocvar{g1} \coqdocvar{a}, \coqref{chap01.indcoprd}{\coqdocdefinition{indcoprd}} \coqdocvariable{C} \coqdocvariable{g0} \coqdocvariable{g1} (\coqref{chap01.myinl}{\coqdocdefinition{myinl}} \coqdocvariable{a}) \coqdocnotation{=} \coqdocvariable{g0} \coqdocvariable{a}. \coqdoceol
\coqdocnoindent
\coqdockw{Goal} \coqdockw{\ensuremath{\forall}} \coqdocvar{C} \coqdocvar{g0} \coqdocvar{g1} \coqdocvar{b}, \coqref{chap01.indcoprd}{\coqdocdefinition{indcoprd}} \coqdocvariable{C} \coqdocvariable{g0} \coqdocvariable{g1} (\coqref{chap01.myinr}{\coqdocdefinition{myinr}} \coqdocvariable{b}) \coqdocnotation{=} \coqdocvariable{g1} \coqdocvariable{b}. \coqdoceol
\coqdocemptyline
\coqdocemptyline
\end{coqdoccode}
\exer{1.6}{56}
...
\coqdocnoindent
\coqdockw{Definition} \coqdef{chap01.mypair}{mypair}{\coqdocdefinition{mypair}} (\coqdocvar{a}:\coqdocvariable{A}) (\coqdocvar{b}:\coqdocvariable{B}) := \coqdocdefinition{Bool\_rect} (\coqdockw{fun} \coqdocvar{x}:\coqdocinductive{Bool} \ensuremath{\Rightarrow} \coqdockw{if} \coqdocvariable{x} \coqdockw{then} \coqdocvariable{A} \coqdockw{else} \coqdocvariable{B}) \coqdocvariable{a} \coqdocvariable{b}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
...
\]
But the defining equality of \begin{coqdoccode}
\coqdocemptyline
\coqdocnoindent
