...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Lemma} \coqdef{chap01.compose' assoc}{compose'\_assoc}{\coqdoclemma{compose'\_assoc}} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{A} \coqdocvar{B} \coqdocvar{C} \coqdocvar{D} : \coqdockw{Type}) (\coqdocvar{f} : \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{B}) (\coqdocvar{g} : \coqdocvariable{B}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{C}) (\coqdocvar{h} : \coqdocvariable{C} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{D}), \coqdoceol
\coqdocindent{1.00em}
...
\coqref{chap01.indprd}{\coqdocdefinition{indprd}} \coqdocvariable{C} \coqdocvariable{g} \coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocvariable{a}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqdocvariable{b}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}} \coqdocnotation{=} \coqdocvariable{g} \coqdocvariable{a} \coqdocvariable{b}.\coqdoceol
\coqdocindent{1.00em}
\coqdockw{Proof}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{trivial}.\coqdoceol
...
\coqref{chap01.indsm}{\coqdocdefinition{indsm}} \coqdocvariable{C} \coqdocvariable{g} \coqdocnotation{(}\coqdocvariable{a}\coqdocnotation{;} \coqdocvariable{b}\coqdocnotation{)} \coqdocnotation{=} \coqdocvariable{g} \coqdocvariable{a} \coqdocvariable{b}.\coqdoceol
\coqdocindent{1.00em}
\coqdockw{Proof}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{trivial}.\coqdoceol
...
\coqdocemptyline
\coqdocindent{1.00em}
\coqdockw{Definition} \coqdef{chap01.Phi'}{Phi'}{\coqdocdefinition{Phi'}} (\coqdocvar{n} : \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}}) := \coqdoceol
\coqdocindent{2.00em}
\coqref{chap01.iter}{\coqdocdefinition{iter}} (\coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{\ensuremath{\times}}} \coqdocvariable{C}) \coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqexternalref{O}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{O}}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqdocvariable{c0}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}} (\coqdockw{fun} \coqdocvar{x} \ensuremath{\Rightarrow} \coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} (\coqexternalref{fst}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocdefinition{fst}} \coqdocvariable{x})\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqdocvariable{cs} (\coqexternalref{fst}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocdefinition{fst}} \coqdocvariable{x}) (\coqexternalref{snd}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocdefinition{snd}} \coqdocvariable{x})\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}) \coqdocvariable{n}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
\noindent
...
\coqdocemptyline
\coqdocindent{1.00em}
\coqdockw{Theorem} \coqdef{chap01.Phi' correct1}{Phi'\_correct1}{\coqdoclemma{Phi'\_correct1}} : \coqexternalref{snd}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocdefinition{snd}} (\coqref{chap01.Phi'}{\coqdocdefinition{Phi'}} 0) \coqdocnotation{=} \coqdocvariable{c0}.\coqdoceol
\coqdocindent{1.00em}
\coqdockw{Proof}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{trivial}.\coqdoceol
...
\coqdocemptyline
\coqdocindent{1.00em}
\coqdockw{Theorem} \coqdef{chap01.Phi' correct2}{Phi'\_correct2}{\coqdoclemma{Phi'\_correct2}} : \coqdockw{\ensuremath{\forall}} \coqdocvar{n}, \coqref{chap01.Phi'}{\coqdocdefinition{Phi'}}(\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvariable{n}) \coqdocnotation{=} \coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvariable{n}\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqdocvariable{cs} \coqdocvariable{n} (\coqexternalref{snd}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocdefinition{snd}} (\coqref{chap01.Phi'}{\coqdocdefinition{Phi'}} \coqdocvariable{n}))\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}.\coqdoceol
\coqdocindent{1.00em}
\coqdockw{Proof}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{intros}. \coqdoctac{induction} \coqdocvar{n}. \coqdoctac{reflexivity}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{transitivity} (\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} (\coqexternalref{fst}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocdefinition{fst}} (\coqref{chap01.Phi'}{\coqdocdefinition{Phi'}} (\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvar{n})))\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{,}} \coqdocvariable{cs} (\coqexternalref{fst}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocdefinition{fst}} (\coqref{chap01.Phi'}{\coqdocdefinition{Phi'}} (\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvar{n}))) (\coqexternalref{snd}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocdefinition{snd}} (\coqref{chap01.Phi'}{\coqdocdefinition{Phi'}} (\coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvar{n})))\coqexternalref{:core scope:'(' x ',' x ',' '..' ',' x ')'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}).\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{reflexivity}.\coqdoceol
\coqdocindent{2.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{End} \coqref{chap01.Exercise4}{\coqdocsection{Exercise4}}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
\exerdone{1.5}{56}  
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{End} \coqref{chap01.Exercise5}{\coqdocsection{Exercise5}}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
\exerdone{1.6}{56}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Section} \coqdef{chap01.Exercise6}{Exercise6}{\coqdocsection{Exercise6}}.\coqdoceol
\coqdocindent{1.00em}
\coqdockw{Context} \{\coqdocvar{A} \coqdocvar{B} : \coqdockw{Type}\}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
...
\coqdocemptyline
\coqdocindent{1.00em}
\coqdockw{Definition} \coqdef{chap01.myuppt}{myuppt}{\coqdocdefinition{myuppt}} `\{\coqdocclass{Funext}\} (\coqdocvar{p} : \coqref{chap01.prd}{\coqdocdefinition{prd}}) : \coqref{chap01.mypair}{\coqdocdefinition{mypair}} (\coqref{chap01.myfst}{\coqdocdefinition{myfst}} \coqdocvariable{p}) (\coqref{chap01.mysnd}{\coqdocdefinition{mysnd}} \coqdocvariable{p}) \coqdocnotation{=} \coqdocvariable{p}.\coqdoceol
\coqdocindent{2.00em}
...
\coqdocemptyline
\coqdocindent{1.00em}
\coqdockw{Lemma} \coqdef{chap01.lemma1 6}{lemma1\_6}{\coqdoclemma{lemma1\_6}} : \coqdockw{\ensuremath{\forall}} \coqdocvar{a} \coqdocvar{b}, \coqref{chap01.myuppt}{\coqdocdefinition{myuppt}} (\coqref{chap01.mypair}{\coqdocdefinition{mypair}} \coqdocvariable{a} \coqdocvariable{b}) \coqdocnotation{=} 1.\coqdoceol
\coqdocindent{1.00em}
\coqdockw{Proof}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{intros}. \coqdoctac{unfold} \coqref{chap01.myuppt}{\coqdocdefinition{myuppt}}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{transitivity} (\coqdocdefinition{path\_forall} (\coqref{chap01.mypair}{\coqdocdefinition{mypair}} (\coqref{chap01.myfst}{\coqdocdefinition{myfst}} (\coqref{chap01.mypair}{\coqdocdefinition{mypair}} \coqdocvar{a} \coqdocvar{b})) (\coqref{chap01.mysnd}{\coqdocdefinition{mysnd}} (\coqref{chap01.mypair}{\coqdocdefinition{mypair}} \coqdocvar{a} \coqdocvar{b}))) \coqdoceol
...
\coqdocindent{2.00em}
\coqdoctac{unfold} \coqref{chap01.mypair}{\coqdocdefinition{mypair}}, \coqref{chap01.myfst}{\coqdocdefinition{myfst}}, \coqref{chap01.mysnd}{\coqdocdefinition{mysnd}}. \coqdoctac{simpl}.\coqdoceol
\coqdocindent{2.00em}
...
\coqdockw{Proof}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{intros}. \coqdoctac{unfold} \coqref{chap01.indprd'}{\coqdocdefinition{indprd'}}. \coqdoctac{unfold} \coqdocdefinition{transport}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{rewrite} \coqref{chap01.lemma1 6}{\coqdoclemma{lemma1\_6}}.\coqdoceol
\coqdocindent{2.00em}
\coqdoctac{unfold} \coqref{chap01.mypair}{\coqdocdefinition{mypair}}, \coqref{chap01.myfst}{\coqdocdefinition{myfst}}, \coqref{chap01.mysnd}{\coqdocdefinition{mysnd}}. \coqdoctac{reflexivity}.\coqdoceol
\coqdocindent{1.00em}
\coqdockw{Qed}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{End} \coqref{chap01.Exercise6}{\coqdocsection{Exercise6}}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
\exerdone{1.7}{56}             
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{chap01.ind}{ind}{\coqdocdefinition{ind}} \{\coqdocvar{A}\} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{C} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{x} \coqdocvar{y} : \coqdocvariable{A}), \coqdocvariable{x} \coqdocnotation{=} \coqdocvariable{y} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdockw{Type}),\coqdoceol
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{chap01.Lemma231}{Lemma231}{\coqdocdefinition{Lemma231}} \{\coqdocvar{A}\} (\coqdocvar{P} : \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdockw{Type}) (\coqdocvar{x} \coqdocvar{y} : \coqdocvariable{A}) (\coqdocvar{p} : \coqdocvariable{x} \coqdocnotation{=} \coqdocvariable{y}) : \coqdocvariable{P}(\coqdocvariable{x}) \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{P}(\coqdocvariable{y}).\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{chap01.isContr}{isContr}{\coqdocdefinition{isContr}} (\coqdocvar{A} : \coqdockw{Type}) := \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{\{}}\coqdocvar{a}\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{:}}\coqdocvariable{A} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{\&}} \coqdockw{\ensuremath{\forall}} (\coqdocvar{x}:\coqdocvariable{A}), \coqdocvar{a} \coqdocnotation{=} \coqdocvariable{x}\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{\}}}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{chap01.Lemma3118}{Lemma3118}{\coqdocdefinition{Lemma3118}} \{\coqdocvar{A}\} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{a}:\coqdocvariable{A}), \coqref{chap01.isContr}{\coqdocdefinition{isContr}} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{\{}}\coqdocvar{x}\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{:}}\coqdocvariable{A} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{\&}} \coqdocvariable{a}\coqdocnotation{=}\coqdocvar{x}\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{\}}}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{intro} \coqdocvar{a}. \coqdoctac{unfold} \coqref{chap01.isContr}{\coqdocdefinition{isContr}}. \coqdoctac{\ensuremath{\exists}} \coqdocnotation{(}\coqdocvar{a}\coqdocnotation{;} 1\coqdocnotation{)}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{chap01.my contr}{my\_contr}{\coqdocdefinition{my\_contr}} \{\coqdocvar{A}\} (\coqdocvar{p}:\coqref{chap01.isContr}{\coqdocdefinition{isContr}} \coqdocvariable{A}) := \coqdocvariable{p}\coqdocnotation{.2}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{chap01.ind'}{ind'}{\coqdocdefinition{ind'}} \{\coqdocvar{A}\} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{a} : \coqdocvariable{A}) (\coqdocvar{C} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{x}:\coqdocvariable{A}), \coqdocvariable{a} \coqdocnotation{=} \coqdocvariable{x} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdockw{Type}),\coqdoceol
...
\coqdocindent{1.00em}
\coqdoctac{assert} (\coqref{chap01.isContr}{\coqdocdefinition{isContr}} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{\{}}\coqdocvar{x}\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{:}}\coqdocvar{A} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{\&}} \coqdocvar{a}\coqdocnotation{=}\coqdocvar{x}\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{\}}}) \coqdockw{as} \coqdocvar{H}. \coqdoctac{apply} \coqref{chap01.Lemma3118}{\coqdocdefinition{Lemma3118}}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{1.00em}
\coqdoctac{apply} \coqref{chap01.Lemma231}{\coqdocdefinition{Lemma231}} \coqdockw{with} (\coqdocvar{x0}:=\coqdocnotation{(}\coqdocvar{a}\coqdocnotation{;} 1\coqdocnotation{)}) (\coqdocvar{y}:=\coqdocnotation{(}\coqdocvar{x}\coqdocnotation{;} \coqdocvar{p}\coqdocnotation{)}).\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Fixpoint} \coqdef{chap01.plus}{plus}{\coqdocdefinition{plus}} (\coqdocvar{n} \coqdocvar{m} : \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}}) : \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} :=\coqdoceol
\coqdocindent{1.00em}
\coqdockw{match} \coqdocvariable{n} \coqdockw{with}\coqdoceol
\coqdocindent{2.00em}
\ensuremath{|} 0 \ensuremath{\Rightarrow} \coqdocvariable{m}\coqdoceol
\coqdocindent{2.00em}
\ensuremath{|} \coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvar{p} \ensuremath{\Rightarrow} \coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} (\coqdocvar{p} \coqref{chap01.:nat scope:x '+' x}{\coqdocnotation{+}} \coqdocvariable{m})\coqdoceol
\coqdocindent{1.00em}
\coqdockw{end}\coqdoceol
\coqdocnoindent
\coqdoceol
\coqdocindent{2.00em}
\coqdockw{where} \coqdef{chap01.:nat scope:x '+' x}{"}{"}n + m" := (\coqref{chap01.plus}{\coqdocdefinition{plus}} \coqdocvar{n} \coqdocvar{m}) : \coqdocvar{nat\_scope}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Fixpoint} \coqdef{chap01.mult}{mult}{\coqdocdefinition{mult}} (\coqdocvar{n} \coqdocvar{m} : \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}}) : \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}} :=\coqdoceol
\coqdocindent{1.00em}
\coqdockw{match} \coqdocvariable{n} \coqdockw{with}\coqdoceol
\coqdocindent{2.00em}
\ensuremath{|} 0 \ensuremath{\Rightarrow} 0\coqdoceol
\coqdocindent{2.00em}
\ensuremath{|} \coqexternalref{S}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{S}} \coqdocvar{p} \ensuremath{\Rightarrow} \coqdocvariable{m} \coqref{chap01.:nat scope:x '+' x}{\coqdocnotation{+}} \coqref{chap01.:nat scope:x '+' x}{\coqdocnotation{(}}\coqdocvar{p} \coqref{chap01.:nat scope:x '*' x}{\coqdocnotation{\ensuremath{\times}}} \coqdocvariable{m}\coqref{chap01.:nat scope:x '+' x}{\coqdocnotation{)}}\coqdoceol
\coqdocindent{1.00em}
\coqdockw{end}\coqdoceol
\coqdocnoindent
\coqdoceol
\coqdocindent{2.00em}
\coqdockw{where} \coqdef{chap01.:nat scope:x '*' x}{"}{"}n * m" := (\coqref{chap01.mult}{\coqdocdefinition{mult}} \coqdocvar{n} \coqdocvar{m}) : \coqdocvar{nat\_scope}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdef{chap01.plus 0 r}{plus\_0\_r}{\coqdoclemma{plus\_0\_r}} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{n} : \coqexternalref{nat}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocinductive{nat}}), \coqdocvariable{n} \coqdocnotation{=} \coqref{chap01.plus}{\coqdocdefinition{plus}} \coqdocvariable{n} 0.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocnoindent
\coqdockw{Infix} \coqdef{chap01.:nat scope:x '<=' x}{"}{"}\ensuremath{\le}" := \coqref{chap01.le}{\coqdocdefinition{le}} : \coqdocvar{nat\_scope}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocindent{12.50em}
\coqdocvariable{m} \coqdocnotation{.1} \coqref{chap01.:nat scope:x '<=' x}{\coqdocnotation{\ensuremath{\le}}} \coqdocnotation{(}\coqref{chap01.fmax}{\coqdocdefinition{fmax}} \coqdocvariable{n}\coqdocnotation{)} \coqdocnotation{.1}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Section} \coqdef{chap01.Exercise12}{Exercise12}{\coqdocsection{Exercise12}}.\coqdoceol
\coqdocindent{1.00em}
\coqdockw{Context} \{\coqdocvar{A} \coqdocvar{B} : \coqdockw{Type}\}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{End} \coqref{chap01.Exercise12}{\coqdocsection{Exercise12}}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
\exerdone{1.13}{57}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Section} \coqdef{chap01.Exercise13}{Exercise13}{\coqdocsection{Exercise13}}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{End} \coqref{chap01.Exercise13}{\coqdocsection{Exercise13}}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
