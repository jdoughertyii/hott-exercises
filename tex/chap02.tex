...
\coqdocindent{1.00em}
\coqdoctac{\ensuremath{\exists}} (\coqdocvar{f} \coqdocvar{k}\coqdocnotation{.1}). \coqdoctac{intro} \coqdocvar{x}. \coqdoctac{transitivity} (\coqdocvar{f} (\coqdocvar{f}\coqdocnotation{\^{}-1} \coqdocvar{x})).\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} (\coqdocdefinition{ap} \coqdocvar{f}). \coqdoctac{apply} (\coqdocvar{k}\coqdocnotation{.2} (\coqdocvar{f}\coqdocnotation{\^{}-1} \coqdocvar{x})).\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} \coqdocmethod{eisretr}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
