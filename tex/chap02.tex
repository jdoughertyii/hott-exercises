...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{chap02.P}{P}{\coqdocdefinition{P}} := \coqdocdefinition{pullback} \coqdocvariable{f} \coqdocvariable{g}.\coqdoceol
\coqdocnoindent
\coqdockw{Definition} \coqdef{chap02.funpull}{funpull}{\coqdocdefinition{funpull}} := \coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{f}) (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{g}).\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{chap02.ex2 11 f}{ex2\_11\_f}{\coqdocdefinition{ex2\_11\_f}} : \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{(}}\coqdocvariable{X} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqref{chap02.P}{\coqdocdefinition{P}}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{)}} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqref{chap02.funpull}{\coqdocdefinition{funpull}}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{intro} \coqdocvar{h}. \coqdoctac{unfold} \coqref{chap02.funpull}{\coqdocdefinition{funpull}}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{refine} \coqdocnotation{(}\coqdockw{fun} \coqdocvar{x}:\coqdocvariable{X} \ensuremath{\Rightarrow} \coqdocnotation{(}\coqdocvar{h} \coqdocvariable{x}\coqdocnotation{).1}\coqdocnotation{;} \coqdocvar{\_}\coqdocnotation{)}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{refine} \coqdocnotation{(}\coqdockw{fun} \coqdocvar{x}:\coqdocvariable{X} \ensuremath{\Rightarrow} \coqdocnotation{(}\coqdocvar{h} \coqdocvariable{x}\coqdocnotation{).2}\coqdocnotation{.1}\coqdocnotation{;} \coqdocvar{\_}\coqdocnotation{)}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} \coqdocdefinition{path\_forall}; \coqdoctac{intro}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{unfold} \coqdocdefinition{compose}. \coqdoctac{apply} \coqdocnotation{(}\coqdocvar{h} \coqdocvar{x}\coqdocnotation{).2.2}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocindent{1.00em}
\coqdoctac{intros} \coqdocvar{z} \coqdocvar{x}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{refine} \coqdocnotation{(}\coqdocvar{z}\coqdocnotation{.1} \coqdocvar{x}\coqdocnotation{;} \coqdocnotation{(}\coqdocvar{z}\coqdocnotation{.2}\coqdocnotation{.1} \coqdocvar{x}\coqdocnotation{;} \coqdocvar{\_}\coqdocnotation{))}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{exact} (\coqdocdefinition{apD10} \coqdocvar{z}\coqdocnotation{.2.2} \coqdocvar{x}).\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdef{chap02.ex2 11}{ex2\_11}{\coqdoclemma{ex2\_11}} : \coqdocnotation{(}\coqdocvariable{X} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqref{chap02.P}{\coqdocdefinition{P}}\coqdocnotation{)} \coqdocnotation{\ensuremath{\eqvsym}} \coqref{chap02.funpull}{\coqdocdefinition{funpull}}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocindent{1.00em}
\coqdoctac{intro} \coqdocvar{h}. \coqdoctac{destruct} \coqdocvar{h} \coqdockw{as} [\coqdocvar{hA} [\coqdocvar{hB} \coqdocvar{p}]].\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{unfold} \coqref{chap02.ex2 11 f}{\coqdocdefinition{ex2\_11\_f}}, \coqref{chap02.ex2 11 g}{\coqdocdefinition{ex2\_11\_g}}. \coqdoctac{simpl}. \coqdocvar{f\_ap}. \coqdocvar{f\_ap}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} \coqdocdefinition{eta\_path\_forall}.\coqdoceol
\coqdocemptyline
\coqdocindent{1.00em}
\coqdoctac{intro} \coqdocvar{h}. \coqdoctac{apply} \coqdocdefinition{path\_forall}; \coqdoctac{intro}. \coqdoctac{simpl}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{repeat} (\coqdoctac{apply} \coqdocdefinition{path\_sigma\_uncurried}; \coqdoctac{\ensuremath{\exists}} 1; \coqdoctac{simpl}).\coqdoceol
\coqdocindent{1.00em}
...
We need to show that $bd \circ g = ac \circ h$.
...
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{refine} (\coqdocdefinition{equiv\_adjointify} \coqdocabbreviation{idmap} \coqdocabbreviation{idmap} \coqdocvar{\_} \coqdocvar{\_}).\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{intro}; \coqdoctac{reflexivity}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{intro}; \coqdoctac{reflexivity}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{chap02.ex2 13 g}{ex2\_13\_g}{\coqdocdefinition{ex2\_13\_g}} : \coqdocinductive{Bool} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{(}}\coqdocinductive{Bool} \coqdocnotation{\ensuremath{\eqvsym}} \coqdocinductive{Bool}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{)}}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{intros}. \coqdoctac{destruct} \coqdocvar{H}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{refine} (\coqdocdefinition{equiv\_adjointify} \coqdocabbreviation{idmap} \coqdocabbreviation{idmap} \coqdocvar{\_} \coqdocvar{\_}); \coqdoctac{intro}; \coqdoctac{reflexivity}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{refine} (\coqdocdefinition{equiv\_adjointify} \coqdocdefinition{negb} \coqdocdefinition{negb} \coqdocvar{\_} \coqdocvar{\_}); \coqdoctac{intro}; \coqdoctac{destruct} \coqdocvar{x}; \coqdoctac{reflexivity}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
...
B'$, so again by univalence $(A \times B) \eqvsym (A' \times B')$. \begin{coqdoccode}
\coqdocemptyline
\coqdocnoindent
