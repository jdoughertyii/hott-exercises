...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{chap02.alpha}{alpha}{\coqdocdefinition{alpha}} : \coqdockw{\ensuremath{\forall}} \{\coqdocvar{A} \coqdocvar{B}:\coqdockw{Type}\} \{\coqdocvar{x} \coqdocvar{y} : \coqdocvariable{A}\} (\coqdocvar{f}: \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{B}) (\coqdocvar{p}:\coqdocvariable{x}\coqdocnotation{=}\coqdocvariable{y}) \coqdocvar{q}, \coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{chap02.beta}{beta}{\coqdocdefinition{beta}} : \coqdockw{\ensuremath{\forall}} \{\coqdocvar{A} \coqdocvar{B}:\coqdockw{Type}\} \{\coqdocvar{x} \coqdocvar{y} : \coqdocvariable{A}\} (\coqdocvar{f}: \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{B}) (\coqdocvar{p}:\coqdocvariable{x}\coqdocnotation{=}\coqdocvariable{y}) \coqdocvar{q}, \coqdoceol
\coqdocindent{1.00em}
...
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} (\coqdocdefinition{isequiv\_adjointify} \coqdocvar{\_} (\coqref{chap02.eq2 3 7}{\coqdocdefinition{eq2\_3\_7}} \coqdocvar{f} \coqdocvar{p}) (\coqref{chap02.alpha}{\coqdocdefinition{alpha}} \coqdocvar{f} \coqdocvar{p}) (\coqref{chap02.beta}{\coqdocdefinition{beta}} \coqdocvar{f} \coqdocvar{p})).\coqdoceol
\coqdocnoindent
\coqdockw{Qed}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
...
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} (\coqdocdefinition{isequiv\_adjointify} \coqdocvar{\_} (\coqdockw{fun} \coqdocvar{q}:(\coqdocvar{x}\coqdocnotation{=}\coqdocvar{z}) \ensuremath{\Rightarrow} \coqdocvar{p}\coqdocnotation{\^{}} \coqdocnotation{@} \coqdocvariable{q}) (\coqref{chap02.alpha'}{\coqdocdefinition{alpha'}} \coqdocvar{p}) (\coqref{chap02.beta'}{\coqdocdefinition{beta'}} \coqdocvar{p})).\coqdoceol
\coqdocnoindent
\coqdockw{Qed}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
