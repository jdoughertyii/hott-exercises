...
\coqdocindent{1.00em}
\coqdoctac{transitivity} \coqdocvar{H}\coqdocnotation{.1}. \coqdoctac{destruct} \coqdocvar{H} \coqdockw{as} [[\coqdocvar{a'} \coqdocvar{p'}] \coqdocvar{z}]. \coqdoctac{simpl}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdoceol
\coqdocindent{2.00em}
\coqdockw{where} \coqdef{Ch01.:nat scope:x '+' x}{"}{"}n + m" := (\coqref{Ch01.plus}{\coqdocdefinition{plus}} \coqdocvar{n} \coqdocvar{m}) : \coqdocvar{nat\_scope}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdoceol
\coqdocindent{2.00em}
\coqdockw{where} \coqdef{Ch01.:nat scope:x '*' x}{"}{"}n * m" := (\coqref{Ch01.mult}{\coqdocdefinition{mult}} \coqdocvar{n} \coqdocvar{m}) : \coqdocvar{nat\_scope}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocnoindent
\coqdockw{Infix} \coqdef{Ch01.:nat scope:x '<=' x}{"}{"}\ensuremath{\le}" := \coqref{Ch01.le}{\coqdocdefinition{le}} : \coqdocvar{nat\_scope}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocnoindent
\coqdockw{Infix} \coqdef{Ch01.:nat scope:x '<' x}{"}{"}<" := \coqref{Ch01.lt}{\coqdocdefinition{lt}} : \coqdocvar{nat\_scope}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
