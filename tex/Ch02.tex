...
\coqdocindent{1.00em}
\coqdocvar{transparent} \coqdoctac{assert} (\coqdocvar{H} : (\coqdocvariable{fsg} \coqdocnotation{o} \coqref{Ch02.e}{\coqdocdefinition{e}}\coqdocnotation{\ensuremath{^{-1}}} \coqdocnotation{(}\coqdocvariable{h} \coqdocnotation{o} \coqdocvar{k}\coqdocnotation{.1}\coqdocnotation{;} \coqdocvar{k}\coqdocnotation{.2}\coqdocnotation{)} \coqdocnotation{=} \coqdocvar{k}\coqdocnotation{.2}\coqdocnotation{.1})).\coqdoceol
\coqdocindent{1.00em}
