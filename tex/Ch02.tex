...
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{intros}. \coqdoctac{apply} \coqdocdefinition{path\_forall}. \coqdoctac{intro} \coqdocvar{z}. \coqdoctac{destruct} \coqdocvar{z}; \coqdoctac{reflexivity}.\coqdoceol
\coqdocnoindent
\coqdockw{Qed}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Variables} (\coqdef{Ch02.Exercise2 12.A}{A}{\coqdocvariable{A}} \coqdef{Ch02.Exercise2 12.B}{B}{\coqdocvariable{B}} \coqdef{Ch02.Exercise2 12.C}{C}{\coqdocvariable{C}} \coqdef{Ch02.Exercise2 12.D}{D}{\coqdocvariable{D}} \coqdef{Ch02.Exercise2 12.E}{E}{\coqdocvariable{E}} \coqdef{Ch02.Exercise2 12.F}{F}{\coqdocvariable{F}} \coqdef{Ch02.Exercise2 12.X}{X}{\coqdocvariable{X}} : \coqdockw{Type}) (\coqdef{Ch02.Exercise2 12.ab}{ab}{\coqdocvariable{ab}}:\coqdocvar{A}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvar{B}) (\coqdef{Ch02.Exercise2 12.ac}{ac}{\coqdocvariable{ac}}:\coqdocvar{A}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvar{C}) (\coqdef{Ch02.Exercise2 12.bd}{bd}{\coqdocvariable{bd}}:\coqdocvar{B}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvar{D})\coqdoceol
\coqdocindent{5.00em}
(\coqdef{Ch02.Exercise2 12.cd}{cd}{\coqdocvariable{cd}}:\coqdocvar{C}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvar{D}) (\coqdef{Ch02.Exercise2 12.ce}{ce}{\coqdocvariable{ce}}:\coqdocvar{C}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvar{E}) (\coqdef{Ch02.Exercise2 12.df}{df}{\coqdocvariable{df}}:\coqdocvar{D}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvar{F}) (\coqdef{Ch02.Exercise2 12.ef}{ef}{\coqdocvariable{ef}}:\coqdocvar{E}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvar{F})\coqdoceol
\coqdocindent{5.00em}
(\coqdef{Ch02.Exercise2 12.l}{l}{\coqdocvariable{l}}: \coqdocvar{bd} \coqdocnotation{o} \coqdocvar{ab} \coqdocnotation{=} \coqdocvar{cd} \coqdocnotation{o} \coqdocvar{ac}) (\coqdef{Ch02.Exercise2 12.r}{r}{\coqdocvariable{r}}: \coqdocvar{df} \coqdocnotation{o} \coqdocvar{cd} \coqdocnotation{=} \coqdocvar{ef} \coqdocnotation{o} \coqdocvar{ce}).\coqdoceol
\coqdocemptyline
\coqdocnoindent
