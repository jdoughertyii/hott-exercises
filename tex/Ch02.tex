...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{Ch02.alpha2 5}{alpha2\_5}{\coqdocdefinition{alpha2\_5}} : \coqdockw{\ensuremath{\forall}} \{\coqdocvar{A} \coqdocvar{B}:\coqdockw{Type}\} \{\coqdocvar{x} \coqdocvar{y} : \coqdocvariable{A}\} (\coqdocvar{f}: \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{B}) (\coqdocvar{p}:\coqdocvariable{x}\coqdocnotation{=}\coqdocvariable{y}) \coqdocvar{q}, \coqdoceol
\coqdocindent{1.00em}
\coqdocnotation{(}\coqref{Ch02.eq2 3 6}{\coqdocdefinition{eq2\_3\_6}} \coqdocvariable{f} \coqdocvariable{p} (\coqref{Ch02.eq2 3 7}{\coqdocdefinition{eq2\_3\_7}} \coqdocvariable{f} \coqdocvariable{p} \coqdocvariable{q})\coqdocnotation{)} \coqdocnotation{=} \coqdocvariable{q}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{Ch02.beta2 5}{beta2\_5}{\coqdocdefinition{beta2\_5}} : \coqdockw{\ensuremath{\forall}} \{\coqdocvar{A} \coqdocvar{B}:\coqdockw{Type}\} \{\coqdocvar{x} \coqdocvar{y} : \coqdocvariable{A}\} (\coqdocvar{f}: \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{B}) (\coqdocvar{p}:\coqdocvariable{x}\coqdocnotation{=}\coqdocvariable{y}) \coqdocvar{q}, \coqdoceol
\coqdocindent{1.00em}
\coqdocnotation{(}\coqref{Ch02.eq2 3 7}{\coqdocdefinition{eq2\_3\_7}} \coqdocvariable{f} \coqdocvariable{p} (\coqref{Ch02.eq2 3 6}{\coqdocdefinition{eq2\_3\_6}} \coqdocvariable{f} \coqdocvariable{p} \coqdocvariable{q})\coqdocnotation{)} \coqdocnotation{=} \coqdocvariable{q}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{unfold} \coqref{Ch02.eq2 3 6}{\coqdocdefinition{eq2\_3\_6}}, \coqref{Ch02.eq2 3 7}{\coqdocdefinition{eq2\_3\_7}}. \coqdocvar{path\_induction}. \coqdoctac{reflexivity}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
...
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} (\coqdocdefinition{isequiv\_adjointify} \coqdocvar{\_} (\coqref{Ch02.eq2 3 7}{\coqdocdefinition{eq2\_3\_7}} \coqdocvar{f} \coqdocvar{p}) (\coqref{Ch02.alpha2 5}{\coqdocdefinition{alpha2\_5}} \coqdocvar{f} \coqdocvar{p}) (\coqref{Ch02.beta2 5}{\coqdocdefinition{beta2\_5}} \coqdocvar{f} \coqdocvar{p})).\coqdoceol
\coqdocnoindent
\coqdockw{Qed}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
...
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} (\coqdocdefinition{isequiv\_adjointify} \coqdocvar{\_} (\coqdockw{fun} \coqdocvar{q}:(\coqdocvar{x}\coqdocnotation{=}\coqdocvar{z}) \ensuremath{\Rightarrow} \coqdocvar{p}\coqdocnotation{\^{}} \coqdocnotation{@} \coqdocvariable{q}) (\coqref{Ch02.alpha2 6}{\coqdocdefinition{alpha2\_6}} \coqdocvar{p}) (\coqref{Ch02.beta2 6}{\coqdocdefinition{beta2\_6}} \coqdocvar{p})).\coqdoceol
\coqdocnoindent
\coqdockw{Qed}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{Ch02.T}{T}{\coqdocdefinition{T}} \{\coqdocvar{A} \coqdocvar{A'} : \coqdockw{Type}\} \{\coqdocvar{B} : \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdockw{Type}\} \{\coqdocvar{B'} : \coqdocvariable{A'} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdockw{Type}\}\coqdoceol
\coqdocindent{5.50em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdef{Ch02.ex2 7}{ex2\_7}{\coqdoclemma{ex2\_7}} : \coqdockw{\ensuremath{\forall}} \{\coqdocvar{A} \coqdocvar{A'} : \coqdockw{Type}\} \{\coqdocvar{B} : \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdockw{Type}\} \{\coqdocvar{B'} : \coqdocvariable{A'} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdockw{Type}\}\coqdoceol
...
\coqdocindent{1.00em}
\coqdocdefinition{ap} \coqdocvariable{f} (\coqdocdefinition{path\_sigma} \coqdocvariable{B} \coqdocvariable{x} \coqdocvariable{y} \coqdocvariable{p} \coqdocvariable{q}) \coqdocnotation{=} \coqdocdefinition{path\_sigma} \coqdocvariable{B'} (\coqdocvariable{f} \coqdocvariable{x}) (\coqdocvariable{f} \coqdocvariable{y}) (\coqdocdefinition{ap} \coqdocvariable{g} \coqdocvariable{p}) (\coqref{Ch02.T}{\coqdocdefinition{T}} \coqdocvariable{h} \coqdocvariable{p} \coqdocvariable{q}).\coqdoceol
\coqdocnoindent
\coqdoctac{intros}. \coqdoctac{unfold} \coqdocvar{f}, \coqref{Ch02.T}{\coqdocdefinition{T}}.\coqdoceol
\coqdocnoindent
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdef{Ch02.ex2 8}{ex2\_8}{\coqdoclemma{ex2\_8}} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{A} \coqdocvar{A'} \coqdocvar{B} \coqdocvar{B'} : \coqdockw{Type})\coqdoceol
\coqdocindent{11.50em}
...
\coqdocindent{11.50em}
(\coqdocvar{x} \coqdocvar{y} : \coqdocvariable{A}\coqexternalref{:type scope:x '+' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{+}}\coqdocvariable{B}) (\coqdocvar{p} : \coqref{Ch02.code}{\coqdocdefinition{code}} \coqdocvariable{x} \coqdocvariable{y}),\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{4.00em}
(\coqdockw{match} \coqdocvariable{x} \coqdockw{return} \coqref{Ch02.code}{\coqdocdefinition{code}} \coqdocvariable{x} \coqdocvariable{y} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqref{Ch02.code}{\coqdocdefinition{code}} (\coqdocvariable{f} \coqdocvariable{x}) (\coqdocvariable{f} \coqdocvariable{y}) \coqdockw{with}\coqdoceol
\coqdocindent{4.50em}
\ensuremath{|} \coqexternalref{inl}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{inl}} \coqdocvar{a} \ensuremath{\Rightarrow} \coqdockw{match} \coqdocvariable{y} \coqdockw{return} \coqref{Ch02.code}{\coqdocdefinition{code}} (\coqexternalref{inl}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{inl}} \coqdocvar{a}) \coqdocvariable{y} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqref{Ch02.code}{\coqdocdefinition{code}} (\coqexternalref{inl}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{inl}} (\coqdocvariable{g} \coqdocvar{a})) (\coqdocvariable{f} \coqdocvariable{y}) \coqdockw{with}\coqdoceol
...
\coqdockw{end}\coqdoceol
\coqdocindent{4.50em}
\ensuremath{|} \coqexternalref{inr}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{inr}} \coqdocvar{b} \ensuremath{\Rightarrow} \coqdockw{match} \coqdocvariable{y} \coqdockw{return} \coqref{Ch02.code}{\coqdocdefinition{code}} (\coqexternalref{inr}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{inr}} \coqdocvar{b}) \coqdocvariable{y} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqref{Ch02.code}{\coqdocdefinition{code}} (\coqexternalref{inr}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocconstructor{inr}} (\coqdocvariable{h} \coqdocvar{b})) (\coqdocvariable{f} \coqdocvariable{y}) \coqdockw{with}\coqdoceol
\coqdocindent{10.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Lemma} \coqdef{Ch02.alpha2 9}{alpha2\_9}{\coqdoclemma{alpha2\_9}} \{\coqdocvar{A} \coqdocvar{B} \coqdocvar{X}: \coqdockw{Type}\} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{h} : \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{X}\coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{\ensuremath{\times}}} \coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{(}}\coqdocvariable{B} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{X}\coqexternalref{:type scope:x '*' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{)}}), \coqdoceol
\coqdocindent{1.00em}
\coqref{Ch02.ex2 9 f}{\coqdocdefinition{ex2\_9\_f}} (\coqref{Ch02.ex2 9 g}{\coqdocdefinition{ex2\_9\_g}} \coqdocvariable{h}) \coqdocnotation{=} \coqdocvariable{h}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{unfold} \coqref{Ch02.ex2 9 f}{\coqdocdefinition{ex2\_9\_f}}, \coqref{Ch02.ex2 9 g}{\coqdocdefinition{ex2\_9\_g}}. \coqdoctac{destruct} \coqdocvar{h} \coqdockw{as} (\coqdocvar{x}, \coqdocvar{y}). \coqdoctac{reflexivity}.\coqdoceol
\coqdocnoindent
\coqdockw{Qed}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Lemma} \coqdef{Ch02.beta2 9}{beta2\_9}{\coqdoclemma{beta2\_9}} `\{\coqdocclass{Funext}\} \{\coqdocvar{A} \coqdocvar{B} \coqdocvar{X}: \coqdockw{Type}\} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{h} : \coqdocvariable{A} \coqexternalref{:type scope:x '+' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{+}} \coqdocvariable{B} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{X}), \coqdoceol
\coqdocindent{1.00em}
\coqref{Ch02.ex2 9 g}{\coqdocdefinition{ex2\_9\_g}} (\coqref{Ch02.ex2 9 f}{\coqdocdefinition{ex2\_9\_f}} \coqdocvariable{h}) \coqdocnotation{=} \coqdocvariable{h}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{intros}. \coqdoctac{apply} (\coqdocdefinition{equiv\_adjointify} \coqref{Ch02.ex2 9 f}{\coqdocdefinition{ex2\_9\_f}} \coqref{Ch02.ex2 9 g}{\coqdocdefinition{ex2\_9\_g}} \coqref{Ch02.alpha2 9}{\coqdoclemma{alpha2\_9}} \coqref{Ch02.beta2 9}{\coqdoclemma{beta2\_9}}).\coqdoceol
\coqdocnoindent
\coqdockw{Qed}.\coqdoceol
\coqdocemptyline
\end{coqdoccode}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Variables} (\coqdef{Ch02.Exercise2 11.A}{A}{\coqdocvariable{A}} \coqdef{Ch02.Exercise2 11.B}{B}{\coqdocvariable{B}} \coqdef{Ch02.Exercise2 11.C}{C}{\coqdocvariable{C}} \coqdef{Ch02.Exercise2 11.X}{X}{\coqdocvariable{X}} : \coqdockw{Type}) (\coqdef{Ch02.Exercise2 11.f}{f}{\coqdocvariable{f}}: \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{C}) (\coqdef{Ch02.Exercise2 11.g}{g}{\coqdocvariable{g}}: \coqdocvariable{B} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{C}).\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Variables} (\coqdef{Ch02.Exercise2 12.A}{A}{\coqdocvariable{A}} \coqdef{Ch02.Exercise2 12.B}{B}{\coqdocvariable{B}} \coqdef{Ch02.Exercise2 12.C}{C}{\coqdocvariable{C}} \coqdef{Ch02.Exercise2 12.D}{D}{\coqdocvariable{D}} \coqdef{Ch02.Exercise2 12.E}{E}{\coqdocvariable{E}} \coqdef{Ch02.Exercise2 12.F}{F}{\coqdocvariable{F}} \coqdef{Ch02.Exercise2 12.X}{X}{\coqdocvariable{X}} : \coqdockw{Type}) (\coqdef{Ch02.Exercise2 12.ab}{ab}{\coqdocvariable{ab}}:\coqdocvariable{A}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvariable{B}) (\coqdef{Ch02.Exercise2 12.ac}{ac}{\coqdocvariable{ac}}:\coqdocvariable{A}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvariable{C}) (\coqdef{Ch02.Exercise2 12.bd}{bd}{\coqdocvariable{bd}}:\coqdocvariable{B}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvariable{D})\coqdoceol
\coqdocindent{5.00em}
(\coqdef{Ch02.Exercise2 12.cd}{cd}{\coqdocvariable{cd}}:\coqdocvariable{C}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvariable{D}) (\coqdef{Ch02.Exercise2 12.ce}{ce}{\coqdocvariable{ce}}:\coqdocvariable{C}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvariable{E}) (\coqdef{Ch02.Exercise2 12.df}{df}{\coqdocvariable{df}}:\coqdocvariable{D}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvariable{F}) (\coqdef{Ch02.Exercise2 12.ef}{ef}{\coqdocvariable{ef}}:\coqdocvariable{E}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvariable{F})\coqdoceol
\coqdocindent{5.00em}
(\coqdef{Ch02.Exercise2 12.l}{l}{\coqdocvariable{l}}: \coqdocvariable{bd} \coqdocnotation{o} \coqdocvariable{ab} \coqdocnotation{=} \coqdocvariable{cd} \coqdocnotation{o} \coqdocvariable{ac}) (\coqdef{Ch02.Exercise2 12.r}{r}{\coqdocvariable{r}}: \coqdocvariable{df} \coqdocnotation{o} \coqdocvariable{cd} \coqdocnotation{=} \coqdocvariable{ef} \coqdocnotation{o} \coqdocvariable{ce}).\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{Ch02.e}{e}{\coqdocdefinition{e}} : \coqdocvariable{df} \coqdocnotation{o} \coqdocvariable{bd} \coqdocnotation{o} \coqdocvariable{ab} \coqdocnotation{=} \coqdocvariable{ef} \coqdocnotation{o} \coqdocvariable{ce} \coqdocnotation{o} \coqdocvariable{ac}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{transitivity} (\coqdocvariable{df} \coqdocnotation{o} \coqdocvariable{cd} \coqdocnotation{o} \coqdocvariable{ac}).\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} (\coqdocdefinition{ap} (\coqdocdefinition{compose} \coqdocvariable{df}) \coqdocvariable{l}).\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} (\coqdocdefinition{ap} (\coqdockw{fun} (\coqdocvar{f}: \coqdocvariable{C} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{F}) \ensuremath{\Rightarrow} \coqdocvariable{f} \coqdocnotation{o} \coqdocvariable{ac}) \coqdocvariable{r}).\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{Ch02.f}{f}{\coqdocdefinition{f}} (\coqdocvar{k} : \coqdocvariable{X}\coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}}\coqdocvariable{C}) : \coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{df}) (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{ef}) :=\coqdoceol
\coqdocindent{1.00em}
\coqdocnotation{(}\coqdocvariable{cd} \coqdocnotation{o} \coqdocvariable{k}\coqdocnotation{;} \coqdocnotation{(}\coqdocvariable{ce} \coqdocnotation{o} \coqdocvariable{k}\coqdocnotation{;} \coqdocdefinition{ap10} (\coqdocdefinition{ap} \coqdocdefinition{compose} \coqdocvariable{r}) \coqdocvariable{k}\coqdocnotation{))}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Hypothesis} \coqdef{Ch02.Exercise2 12.right pullback}{right\_pullback}{\coqdocvariable{right\_pullback}} : \coqdocclass{IsEquiv}(\coqref{Ch02.f}{\coqdocdefinition{f}}).\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Lemma} \coqdef{Ch02.comp cd is pr1}{comp\_cd\_is\_pr1}{\coqdoclemma{comp\_cd\_is\_pr1}} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{k} : \coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{df}) \coqdoceol
\coqdocindent{23.00em}
(@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{ef})),\coqdoceol
\coqdocindent{13.50em}
\coqdocvariable{cd} \coqdocnotation{o} \coqref{Ch02.f}{\coqdocdefinition{f}}\coqdocnotation{\ensuremath{^{-1}}} \coqdocvariable{k} \coqdocnotation{=} \coqdocvariable{k}\coqdocnotation{.1}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{intros}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{change} (\coqdocvariable{cd} \coqdocnotation{o} \coqref{Ch02.f}{\coqdocdefinition{f}}\coqdocnotation{\ensuremath{^{-1}}} \coqdocvar{k}) \coqdockw{with} \coqdocnotation{(}\coqref{Ch02.f}{\coqdocdefinition{f}} (\coqref{Ch02.f}{\coqdocdefinition{f}}\coqdocnotation{\ensuremath{^{-1}}} \coqdocvar{k})\coqdocnotation{).1}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} (\coqdocdefinition{ap} \coqdocabbreviation{pr1} (\coqdocmethod{eisretr} \coqref{Ch02.f}{\coqdocdefinition{f}} \coqdocvar{k})).\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Lemma} \coqdef{Ch02.comp ce is pr2}{comp\_ce\_is\_pr2}{\coqdoclemma{comp\_ce\_is\_pr2}} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{k} : \coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{df}) \coqdoceol
\coqdocindent{23.00em}
(@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{ef})),\coqdoceol
\coqdocindent{13.50em}
\coqdocvariable{ce} \coqdocnotation{o} \coqref{Ch02.f}{\coqdocdefinition{f}}\coqdocnotation{\ensuremath{^{-1}}} \coqdocvariable{k} \coqdocnotation{=} \coqdocvariable{k}\coqdocnotation{.2}\coqdocnotation{.1}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{intros}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{change} (\coqdocvariable{ce} \coqdocnotation{o} \coqref{Ch02.f}{\coqdocdefinition{f}}\coqdocnotation{\ensuremath{^{-1}}} \coqdocvar{k}) \coqdockw{with} \coqdocnotation{(}\coqref{Ch02.f}{\coqdocdefinition{f}} (\coqref{Ch02.f}{\coqdocdefinition{f}}\coqdocnotation{\ensuremath{^{-1}}} \coqdocvar{k})\coqdocnotation{).2}\coqdocnotation{.1}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} (\coqdocdefinition{ap} ((\coqdockw{fun} (\coqdocvar{k} : \coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{df}) (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{ef}))\coqdoceol
\coqdocindent{9.50em}
\ensuremath{\Rightarrow} \coqdocvariable{k}\coqdocnotation{.2}\coqdocnotation{.1}))\coqdoceol
\coqdocindent{6.50em}
(@\coqdocmethod{eisretr} (\coqdocvariable{X} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{C}) \coqdoceol
\coqdocindent{11.50em}
(\coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{df}) (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{ef}))\coqdoceol
\coqdocindent{11.50em}
\coqref{Ch02.f}{\coqdocdefinition{f}} \coqdoceol
\coqdocindent{11.50em}
\coqdocvariable{right\_pullback}\coqdoceol
\coqdocindent{11.50em}
\coqdocvar{k})).\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{Ch02.phi}{phi}{\coqdocdefinition{phi}} (\coqdocvar{k}: \coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{bd}) (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{cd}))\coqdoceol
\coqdocnoindent
: \coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} (\coqdocvariable{df} \coqdocnotation{o} \coqdocvariable{bd})) (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{ef}) :=\coqdoceol
\coqdocindent{1.00em}
\coqdocnotation{(}\coqdocvariable{k}\coqdocnotation{.1}\coqdocnotation{;} \coqdocnotation{(}\coqdocvariable{ce} \coqdocnotation{o} \coqdocvariable{k}\coqdocnotation{.2}\coqdocnotation{.1}\coqdocnotation{;} \coqdocnotation{(}\coqdocdefinition{ap} (\coqdocdefinition{compose} \coqdocvariable{df}) \coqdocvariable{k}\coqdocnotation{.2.2}\coqdocnotation{)} \coqdocnotation{@} \coqdocnotation{(}\coqdocdefinition{ap10} (\coqdocdefinition{ap} \coqdocdefinition{compose} \coqdocvariable{r}) \coqdocvariable{k}\coqdocnotation{.2}\coqdocnotation{.1}\coqdocnotation{)}\coqdocnotation{))}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Definition} \coqdef{Ch02.phi inv}{phi\_inv}{\coqdocdefinition{phi\_inv}} (\coqdocvar{k}: \coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} (\coqdocvariable{df} \coqdocnotation{o} \coqdocvariable{bd})) (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{ef}))\coqdoceol
\coqdocnoindent
: \coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{bd}) (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{cd}) :=\coqdoceol
\coqdocindent{1.00em}
\coqdocnotation{(}\coqdocvariable{k}\coqdocnotation{.1}\coqdocnotation{;} \coqdocnotation{(}\coqref{Ch02.f}{\coqdocdefinition{f}}\coqdocnotation{\ensuremath{^{-1}}} \coqdocnotation{(}\coqdocvariable{bd} \coqdocnotation{o} \coqdocvariable{k}\coqdocnotation{.1}\coqdocnotation{;} \coqdocvariable{k}\coqdocnotation{.2}\coqdocnotation{);} \coqdocnotation{(}\coqdocdefinition{base\_path} (\coqdocmethod{eisretr} \coqref{Ch02.f}{\coqdocdefinition{f}} \coqdocnotation{(}\coqdocvariable{bd} \coqdocnotation{o} \coqdocvariable{k}\coqdocnotation{.1}\coqdocnotation{;} \coqdocvariable{k}\coqdocnotation{.2}\coqdocnotation{)})\coqdocnotation{)\^{}}\coqdocnotation{))}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Lemma} \coqdef{Ch02.ex2 12 alpha}{ex2\_12\_alpha}{\coqdoclemma{ex2\_12\_alpha}} : \coqdockw{\ensuremath{\forall}} \coqdocvar{k}, \coqref{Ch02.phi}{\coqdocdefinition{phi}} (\coqref{Ch02.phi inv}{\coqdocdefinition{phi\_inv}} \coqdocvariable{k}) \coqdocnotation{=} \coqdocvariable{k}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{unfold} \coqref{Ch02.phi}{\coqdocdefinition{phi}}, \coqref{Ch02.phi inv}{\coqdocdefinition{phi\_inv}}. \coqdoctac{intro} \coqdocvar{k}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} \coqdocdefinition{path\_sigma\_uncurried}. \coqdoctac{\ensuremath{\exists}} 1. \coqdoctac{simpl}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} \coqdocdefinition{path\_sigma\_uncurried}. \coqdoctac{simpl}. \coqdoctac{\ensuremath{\exists}} (\coqref{Ch02.comp ce is pr2}{\coqdoclemma{comp\_ce\_is\_pr2}} \coqdocnotation{(}\coqdocvariable{bd} \coqdocnotation{o} \coqdocvar{k}\coqdocnotation{.1}\coqdocnotation{;} \coqdocvar{k}\coqdocnotation{.2}\coqdocnotation{)}).\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{unfold} \coqref{Ch02.comp ce is pr2}{\coqdoclemma{comp\_ce\_is\_pr2}}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{rewrite} \coqdoclemma{trans\_paths}. \coqdoctac{rewrite} \coqdocdefinition{ap\_const}. \coqdoctac{simpl}. \coqdoctac{rewrite} \coqdocdefinition{concat\_1p}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{rewrite} \ensuremath{\leftarrow} \coqdocdefinition{ap\_apply\_Fl}.\coqdoceol
\coqdocnoindent
\coqdocvar{Admitted}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Lemma} \coqdef{Ch02.ex2 12 beta}{ex2\_12\_beta}{\coqdoclemma{ex2\_12\_beta}} : \coqdockw{\ensuremath{\forall}} \coqdocvar{k}, \coqref{Ch02.phi inv}{\coqdocdefinition{phi\_inv}} (\coqref{Ch02.phi}{\coqdocdefinition{phi}} \coqdocvariable{k}) \coqdocnotation{=} \coqdocvariable{k}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{intro} \coqdocvar{k}. \coqdoctac{unfold} \coqref{Ch02.phi inv}{\coqdocdefinition{phi\_inv}}, \coqref{Ch02.phi}{\coqdocdefinition{phi}}. \coqdoctac{simpl}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} \coqdocdefinition{path\_sigma\_uncurried}. \coqdoctac{\ensuremath{\exists}} 1. \coqdoctac{simpl}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} \coqdocdefinition{path\_sigma\_uncurried}. \coqdoctac{simpl}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{assert} (\coqref{Ch02.f}{\coqdocdefinition{f}}\coqdocnotation{\ensuremath{^{-1}}} \coqdocnotation{(}\coqdocvariable{bd} \coqdocnotation{o} \coqdocvar{k} \coqdocnotation{.1}\coqdocnotation{;} \coqdoceol
\coqdocindent{8.00em}
\coqdocnotation{(}\coqdocvariable{ce} \coqdocnotation{o} \coqdocvar{k}\coqdocnotation{.2}\coqdocnotation{.1}\coqdocnotation{;} \coqdoceol
\coqdocindent{8.50em}
\coqdocdefinition{ap} (\coqdocdefinition{compose} \coqdocvariable{df}) \coqdocvar{k}\coqdocnotation{.2.2} \coqdocnotation{@} \coqdocdefinition{ap10} (\coqdocdefinition{ap} \coqdocdefinition{compose} \coqdocvariable{r}) \coqdocvar{k}\coqdocnotation{.2}\coqdocnotation{.1}\coqdocnotation{))} \coqdoceol
\coqdocindent{5.00em}
\coqdocnotation{=} \coqdocvar{k}\coqdocnotation{.2}\coqdocnotation{.1}).\coqdoceol
\coqdocnoindent
\coqdocvar{Admitted}.\coqdoceol
\coqdocemptyline
\coqdocemptyline
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdef{Ch02.ex2 12 helper}{ex2\_12\_helper}{\coqdoclemma{ex2\_12\_helper}} : \coqdoceol
\coqdocindent{1.00em}
\coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{bd}) (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{cd})\coqdoceol
\coqdocindent{1.00em}
\coqdocnotation{\ensuremath{\eqvsym}} \coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} (\coqdocvariable{df} \coqdocnotation{o} \coqdocvariable{bd})) (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{ef}).\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} (\coqdocdefinition{equiv\_adjointify} \coqref{Ch02.phi}{\coqdocdefinition{phi}} \coqref{Ch02.phi inv}{\coqdocdefinition{phi\_inv}} \coqref{Ch02.ex2 12 alpha}{\coqdocaxiom{ex2\_12\_alpha}} \coqref{Ch02.ex2 12 beta}{\coqdocaxiom{ex2\_12\_beta}}).\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdef{Ch02.ex2 12}{ex2\_12}{\coqdoclemma{ex2\_12}} : \coqdoceol
\coqdocindent{1.00em}
\coqdocnotation{(}\coqdocvariable{X} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{A}\coqdocnotation{)} \coqdocnotation{\ensuremath{\eqvsym}} \coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{bd}) (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{cd})\coqdoceol
\coqdocindent{1.00em}
\coqexternalref{:type scope:x '<->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Datatypes}{\coqdocnotation{\ensuremath{\leftrightarrow}}}\coqdoceol
\coqdocindent{1.00em}
\coqdocnotation{(}\coqdocvariable{X} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqdocvariable{A}\coqdocnotation{)} \coqdocnotation{\ensuremath{\eqvsym}} \coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} (\coqdocvariable{df} \coqdocnotation{o} \coqdocvariable{bd})) (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{ef}).\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
...
\coqdoctac{intros}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} (@\coqdocdefinition{equiv\_compose'} \coqdocvar{\_} (\coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{bd}) (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{cd}))).\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} \coqref{Ch02.ex2 12 helper}{\coqdoclemma{ex2\_12\_helper}}. \coqdoctac{apply} \coqdocvar{X0}.\coqdoceol
\coqdocemptyline
\coqdocindent{1.00em}
\coqdoctac{intros}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} (@\coqdocdefinition{equiv\_compose'} \coqdocvar{\_} (\coqdocdefinition{pullback} (@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} (\coqdocvariable{df} \coqdocnotation{o} \coqdocvariable{bd}))\coqdoceol
\coqdocindent{18.50em}
(@\coqdocdefinition{compose} \coqdocvariable{X} \coqdocvar{\_} \coqdocvar{\_} \coqdocvariable{ef}))).\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{apply} (\coqdoclemma{equiv\_inverse} \coqref{Ch02.ex2 12 helper}{\coqdoclemma{ex2\_12\_helper}}). \coqdoctac{apply} \coqdocvar{X0}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocemptyline
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Lemma} \coqdef{Ch02.contr equiv commute}{contr\_equiv\_commute}{\coqdoclemma{contr\_equiv\_commute}} \{\coqdocvar{A} \coqdocvar{B}\} : \coqdocvariable{A} \coqdocnotation{\ensuremath{\eqvsym}} \coqdocvariable{B} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqref{Ch02.isContr}{\coqdocdefinition{isContr}} \coqdocvariable{A} \coqexternalref{:type scope:x '->' x}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Logic}{\coqdocnotation{\ensuremath{\rightarrow}}} \coqref{Ch02.isContr}{\coqdocdefinition{isContr}} \coqdocvariable{B}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
\coqdoctac{intros} \coqdocvar{f} \coqdocvar{k}. \coqdoctac{unfold} \coqref{Ch02.isContr}{\coqdocdefinition{isContr}} \coqdoctac{in} *.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Lemma} \coqdef{Ch02.reduce to refl}{reduce\_to\_refl}{\coqdoclemma{reduce\_to\_refl}} \{\coqdocvar{A} \coqdocvar{B} \coqdocvar{f}\} : \coqref{Ch02.isContr}{\coqdocdefinition{isContr}} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{\{}}\coqdocvar{g} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{:}} \coqdockw{\ensuremath{\forall}} \coqdocvar{x}:\coqdocvariable{A}, \coqdocvariable{B} \coqdocvariable{x} \coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{\&}} \coqdocvariable{f} \coqdocnotation{\ensuremath{\sim}} \coqdocvar{g}\coqexternalref{:type scope:'x7B' x ':' x 'x26' x 'x7D'}{http://coq.inria.fr/distrib/8.4pl3/stdlib/Coq.Init.Specif}{\coqdocnotation{\}}}.\coqdoceol
\coqdocnoindent
\coqdockw{Proof}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{2.00em}
\coqdoctac{destruct} \coqdocvar{X}. \coqdoctac{rewrite} \coqdocnotation{(}\coqdocvar{p} \coqdocvar{k}\coqdocnotation{)\^{}}. \coqdoctac{apply} \coqdocnotation{(}\coqdocvar{p} (\coqref{Ch02.total happly}{\coqdocdefinition{total\_happly}} (\coqref{Ch02.total happly inv}{\coqdocdefinition{total\_happly\_inv}} \coqdocvar{x}))\coqdocnotation{)\^{}}.\coqdoceol
\coqdocindent{1.00em}
...
\coqdocindent{2.00em}
\coqdoctac{destruct} \coqdocvar{X}. \coqdoctac{rewrite} \coqdocnotation{(}\coqdocvar{p} \coqdocvar{k}\coqdocnotation{)\^{}}. \coqdoctac{apply} \coqdocnotation{(}\coqdocvar{p} (\coqref{Ch02.total happly inv}{\coqdocdefinition{total\_happly\_inv}} (\coqref{Ch02.total happly}{\coqdocdefinition{total\_happly}} \coqdocvar{x}))\coqdocnotation{)\^{}}.\coqdoceol
\coqdocnoindent
\coqdockw{Defined}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
